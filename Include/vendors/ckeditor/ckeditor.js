...
(function () {
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, f = />/g, d = /</g, e = /"/g, g = /&amp;/g, n = /&gt;/g, h = /&lt;/g, i = /&quot;/g;
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, c = function (a, d) {
                ...
                table: 1,
                ul: 1
            }, e = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, g = {}, n = {"#": 1},
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var m =
                            this.$.getBoundingClientRect(), p = f.$.documentElement, s = p.clientTop || h.$.clientTop || 0,
                        x = p.clientLeft || h.$.clientLeft || 0, q = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function a(a, b) {
            ...
            d = c.endContainer;
            var f = c.startOffset, m = c.endOffset, k, l = this.guard, j = this.type,
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(),
            n = CKEDITOR.dom.walker.bookmark(), h = CKEDITOR.dom.walker.temp();
    ...
    (function () {
        function a() {
            var a = false, b = CKEDITOR.dom.walker.whitespaces(), d = CKEDITOR.dom.walker.bookmark(true),
        ...
        CKEDITOR.dom.range.prototype =
            {
                clone: function () {
                    ...
                    return function (b) {
                        var d = this.collapsed, c = {container: this.startContainer, offset: this.startOffset},
                    ...
                    if (a.is2) {
                        var b = this.document.getByAddress(a.start, a.normalized), d = a.startOffset,
                ...
                getBoundaryNodes: function () {
                    ...
                    switch (a) {
                        ...
                        case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                            ...
                            var J, w,
                                z = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                                t = null, E = function (a) {
                    ...
                    if (!this.collapsed) {
                        var a = a || CKEDITOR.SHRINK_TEXT, c = this.clone(), e = this.startContainer,
                            f = this.endContainer, u = this.startOffset, g = this.endOffset, k = 1, l = 1;
                ...
                setEndAt: function (a, b) {
                    ...
                    var b = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                        d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), c = b.block, e = d.block,
                        f = null;
                ...
                getPreviousNode: function (a, b, d) {
                    ...
                    var d = new CKEDITOR.dom.range(this.root), c = 0, e,
                    ...
                    var a = new CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>", this.document), b, d, c,
                        e = this.clone();
                    e.optimize();
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, d, c) {
                ...
                var e = this, f = [], o = this.editor && this.editor.config.protectedSource, k, l = false,
                    g = {doFilter: !d, doTransform: true, doCallbacks: true, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
        ...
        var t = {styles: 1, attributes: 1, classes: 1}, E = {
            ...
            ba = /^cke:(object|embed|param)$/, ca = /^(object|embed|param)$/,
        ...
        CKEDITOR.lang = {
            languages: {
                ...
                var b = this.languages, c = c || navigator.userLanguage || navigator.language || a,
                    f = c.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), d = f[1], f = f[2];
    ...
    (function () {
        ...
        function m(a) {
            ...
            if (c) var f = RegExp("(?:^|,)(?:" + c.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), d = d.replace(f, ""),
                d = d + ("," + c);
            ...
            function (e, g, n) {
                ...
                function s(a, b) {
                    if ((a == o || a.name == "body") && n && (!a.name || CKEDITOR.dtd[a.name][n])) {
                        var d, c;
                        return (d = b.attributes && (c = b.attributes["data-cke-real-element-type"]) ? c : b.name) && d in CKEDITOR.dtd.$inline &&
                ...
                var q = new CKEDITOR.htmlParser,
                    ...
                    u = [], A = [], k = o, l = o.name == "textarea", j = o.name == "pre";
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    e = Array.prototype.slice.call(arguments, 1), g = this.rules, n = g.length, h, i, m, p;
                for (p = 0; p < n; p++) {
                    if (d) {
                        h = c.type;
                        i = c.name
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                    var a = a.data, d = a.dataValue, d = o(d, b), d = m(d, J), d = i(d), d = m(d, L),
                        d = d.replace(z, "$1cke:$2"), d = d.replace(E, "<cke:$1$2></cke:$1>"),
                        d = d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
                        d = d.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi,
        ...
        var u = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", k = CKEDITOR.dtd,
            l = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            j = CKEDITOR.tools.extend({}, k.$blockLimit, k.$block), v = {elements: {input: n, textarea: n}},
        ...
        var S = /<(a|area|img|input|source)\b([^>]*)>/gi,
            F = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, D = /^(href|src|name)$/i,
            L = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            J = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, w = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            z = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            t = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, E = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, f) {
            var h = this.container, i = this.ui.space("contents"),
    ...
    (function () {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    g(this);
                    var b = this.editor, c = b.activeEnterMode, b = b.getSelection(), d = b.getRanges()[0],
                        e = a.getName(), e = CKEDITOR.dtd.$block[e];
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in l) {
                                var b = a.getSelection(), f, k = b.getRanges()[0], g = k.startPath(), h, i, m,
                                    c = c == 8;
        ...
        var i = CKEDITOR.dom.walker.bogus(),
            ...
            p = CKEDITOR.dom.walker.whitespaces(true), s = CKEDITOR.dom.walker.bookmark(false, true);
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            f.on("contentDom", function () {
                var b = f.document, d = CKEDITOR.document, g = f.editable(), k = b.getBody(),
                    l = b.getDocumentElement(), h = g.isInline(), m, n;
    ...
    (function () {
        ...
        var I = {
            ...
            }, r =
                {
                    ...
                    audio: 1,
                    video: 1
                }, O = /\s*(?:;\s*|$)/, S = /#\((.+?)\)/g, F = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var c = this.$.parentNode, b = c.childNodes.length, f = this.getLength(), d = this.getDocument(),
    ...
    (function () {
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function (c, e, b, h) {
                if (b = b || r(c)) {
                    var f = b.document, i = b.checkStartOfBlock(), k = b.checkEndOfBlock(),
                        j = c.elementPath(b.startContainer), a = j.block, l = e == CKEDITOR.ENTER_DIV ? "div" : "p", d;
                    if (i && k) {
                        if (a && (a.is("li") || a.getParent().is("li"))) {
                            ...
                            b = a.getParent();
                            d = b.getParent();
                            var h = !a.hasPrevious(), n = !a.hasNext(), l = c.getSelection(), g = l.createBookmarks(),
                                i = a.getDirection(1), k = a.getAttribute("class"), o = a.getAttribute("style"),
                                m = d.getDirection(1) != i, c = c.enterMode != CKEDITOR.ENTER_BR || m || o || k;
                    ...
                    if (i = b.splitBlock(l)) {
                        ...
                        b.scrollIntoView()
                                  ...
                                  b, h) {
                if (b = b || r(c)) {
                    var f = b.document, i = b.checkEndOfBlock(),
                        k = new CKEDITOR.dom.elementPath(c.getSelection().getStartElement()), j = k.block,
                        a = j && k.block.getName();
