...
class nomad_mimemail {
	...
	var $error_msg = array(
			1	=>	'Correo no se ha enviado',
			2	=>	'Body Incompleto',
			3	=>	'Necesitamos un destinatario de correo en mail_to',
			4	=>	'Direcci�n de correo electr�nico no v�lido: ',
			5	=>	'No se puede abrir el archivo',
			6	=>	'No puede conectarse al servidor SMTP.',
			7	=>	'Respuesta no esperada de SMTP: '
	);
	...
	function set_from($mail_from, $name = ""){
		if ($this->_validate_mail($mail_from)){
			...
			$this->mail_from = "Anonymous <noreply@noreply.com>";
		}
	}
