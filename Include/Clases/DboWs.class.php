<?php
require_once('DBWS.php');

/* CONSTANTES DE OPCIONES DE CLASE */
define('CLS_OP_ERROR_DETENER_WS', true); // Detiene la ejecucion del sistema si hay errores
define('CLS_OP_ERROR_VER_WS', true); // Muestra los todos los errores
define('CLS_OP_ERROR_PROGRAMADOR_WS', true); // Muestra los errores
define('CLS_OP_ERROR_TIPOMSG_WS', 'txt'); // Valores => txt, js, html
define('CLS_OP_ERROR_AUDITORIA_LOG_WS', false);
define('CLS_OP_ERROR_AUDITORIA_LOG_EXT_WS', 'err');
define('CLS_OP_ERROR_AUDITORIA_MAIL_WS', false);
define('CLS_OP_ERROR_AUDITORIA_MAIL_PARA_WS', 'danny.rosero@gmail.com');
define('CLS_OP_ERROR_AUDITORIA_MAIL_ASUNTO_WS', 'Error del sistema');
define('CLS_OP_ERROR_AUDITORIA_MAIL_TIPO_WS', 'html');
define('CLS_OP_AUDITORIA_LOG_WS', false);    // Crea un archivo de txt con todas las transacciones realizadas a la base
define('CLS_OP_AUDITORIA_LOG_EXT_WS', 'las');
...
//		if (CLS_OP_ERROR_VER_WS){
//			if ($sistema){
//				$this->alerta($msg->getMessage() .'  Code: '. $msg->getCode(), '.:: '.$titulo.' ::.', 0,CLS_OP_ERROR_TIPOMSG_WS);
//				if (CLS_OP_ERROR_PROGRAMADOR_WS)
//					$this->alerta($msg->getDebugInfo(), '.:: '.$tituloDebug.' ::.', 0, CLS_OP_ERROR_TIPOMSG_WS);
//				}else{
//					$this->alerta($msg, '.:: '.$titulo.' ::.', 0,CLS_OP_ERROR_TIPOMSG_WS);
//				}
//		}
//		if(CLS_OP_ERROR_DETENER_WS){
//			$this->alerta('.::  SISTEMA DETENIDO ::.', '.:: Alerta ::.', 2, CLS_OP_ERROR_TIPOMSG_WS);
//			exit;
//		}
//	}
