...
class WhatsAppConnection
{
    ...
    function __construct($database, $idempresa)
    {
        ...
        $sql = "SELECT empr_cod_empr, empr_nom_empr, empr_whatsapp_sn, empr_whatsapp_url, empr_whatsapp_token
                    FROM saeempr 
        ...
        foreach($result as $empresa){
            $this->empr_whatsapp_sn =  $empresa["empr_whatsapp_sn"];
            $this->empr_whatsapp_url = $empresa["empr_whatsapp_url"];
            $this->empr_whatsapp_token = $empresa["empr_whatsapp_token"];
