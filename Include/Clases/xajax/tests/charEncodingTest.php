...
<p><strong>NOTE:</strong> if you change these options, make sure you click the Save Options button or the options won't
	be used.</p>
...
<form id="optionsForm" onsubmit="return false;">
	...
	<p><input type="submit" value="Save Options"
			  onclick="xajax_setOptions(xajax.getFormValues('optionsForm')); return false;" /></p>
</form>
...
<p><a href="http://www.i18nguy.com/unicode-example.html" target="_blank">Here are some Unicode examples</a> you can
	paste into the text box below. You can see <a href="http://www.unicode.org/iuc/iuc10/languages.html"
