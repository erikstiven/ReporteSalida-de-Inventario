...
class FusionCharts{
	...
	var $styleAppCounter;             # Apply counter
	 ...
	 function FusionCharts($chartType="column2d",$width="400",$height="300",$chartID="",$isTransparent=true){
...
#------------------------- Public Functions ----------------------------------------------
	...
	# The getXML() function renders final chart XML and returns it
	 ...
	 function renderChartFromExtXML($dataXML,$renderAsHTML=false){
		...
		if($renderAsHTML==true){
		 return $this->renderChartHTML($this->SWFFile . $this->chartMSG ,"", $dataXML, $this->chartID,  $this->width, $this->height, $this->JSC["debugmode"], $this->JSC["registerwithjs"], $this->wMode);
		}else{
		 return $this->renderChartJS($this->SWFFile,"",$dataXML,$this->chartID, $this->width, $this->height,$this->JSC["debugmode"], $this->JSC["registerwithjs"], $this->wMode);
		}
	  }
    ...
    function renderChartHTML($chartSWF, $strURL, $strXML, $chartId, $chartWidth, $chartHeight, $debugMode=false,$registerWithJS=false, $setTransparent="") {
        ...
        $strHTML .= "\n<!-- START Code Block for Chart $chartId -->\n\n";
		 ...
		 if($pos===false){
            ...
            $strHTML .= "<object classid=\"clsid:d27cdb6e-ae6d-11cf-96b8-444553540000\" codebase=\"$HTTP://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0\" width=\"$chartWidth\" height=\"$chartHeight\" id=\"$chartId\" style=\"z-index: -1;\"> \n";
