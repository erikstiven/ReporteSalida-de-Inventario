...
function formato_recibo($id, $cliente){
        ...
        if ($oIfx->Query($sqlDeta)) {
            if ($oIfx->NumFilas() > 0) {
                ...
                elseif($dfac_obj_iva ==1 && $dfac_exc_iva!=1){
                    ...
                    $deta .= ' <tr>';
                    $deta .= ' <td style="width: 150;font-family: Arial; font-size: 7px;" align="justify">'.$dfac_nom_prod.'&nbsp;&nbsp;' . $dfac_det_dfac . '</td>';
         ...
         if($fact_cod_mone==$pcon_seg_mone)
    {
        ...
        <tr>
                ...
                <table align="left" >
                    <tr>
                        <td style="font-size: 7px;font-family: Arial;" align="left" width="55"><b>CODIGO:</b></td>
...
function formato_recibo_elec($id, $cliente){
    ...
    $ruta=DIR_FACTELEC . 'modulos/int_facturacion/qr_facturas/REC_'.$id.'.png';
        ...
        $html .=    '
                        ...
                        <tr>
                            <td style="font-size: 7px;font-family: Arial;" align="center" colspan="2" width="200">Representación impresa de la boleta de venta electrónica,
                            para consultar el documento ingrese a: http://www.mundoapu.com:8080/telecom/</td>
                        </tr>
                        </table>
