...
function formato_recibo($id, $cliente){
    ...
    $sql_sucu = "select sucu_nom_sucu, sucu_dir_sucu, sucu_telf_secu from saesucu where sucu_cod_empr = $idEmpresa and sucu_cod_sucu = $idSucursal ";
    if ($oIfx->Query($sql_sucu)) {
        if ($oIfx->NumFilas() > 0) {
            do {
                $sucu_nom_sucu = $oIfx->f('sucu_nom_sucu');
                $sucu_dir_sucu = $oIfx->f('sucu_dir_sucu');
                $sucu_telf_sucu = $oIfx->f('sucu_telf_secu');
    ...
    if ($contador > 0) {
        ...
        $deta = ' <table style="width: 100%;" style="margin-left:5px;">
                    <tr>
                        <td colspan="2" style="border-top: 1px solid black;"></td>
                    </tr>';
        $deta .= ' <tr>';
        $deta .= ' <b> <td style="width: 120; font-size: 11px;font-family: Arial;" align="left">CONCEPTO</td> </b>';
        $deta .= ' <b> <td style="width: 50; font-size: 11px;font-family: Arial;" align="left">IMPORTE</td> </b>';
        $deta .= ' </tr>
                    <tr>
                        <td colspan="2" style="border-top: 1px solid black;"></td>
                    </tr>';
        ...
        if ($oIfx->Query($sqlDeta)) {
            if ($oIfx->NumFilas() > 0) {
                ...
                elseif($dfac_obj_iva ==1 && $dfac_exc_iva!=1){
                    ...
                    $deta .= ' <tr>';
                    $deta .= ' <td style="width: 170; font-family: Arial; font-size:12px;">' . $dfac_det_dfac . '</td>';
                    $deta .= ' <td style="width: 50; font-family: Arial; font-size:12px;" align="right">' . number_format($dfac_mont_total, 2, '.', ',') . '</td>';
                    $deta .= ' </tr>';
        ...
        $oIfx->Free();
        //$importe_total = number_format($fact_con_miva + $fact_sin_miva + $fact_iva + $fact_fle_fact + $fact_otr_fact + $fact_fin_fact - $totalDescuento, 2, '.', '');
        $V = new EnLetras();
        ...
        $totales = ' <table style="width: 100%;margin-left:5px;" >';

       // &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 170;font-size: 11px;font-family: Arial;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OPERACION GRAVADA</td></b>';
        $totales .= ' <td style="width: 50;font-size: 12px;font-family: Arial;" align="right">' . number_format($tot_opgrav, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 170;font-size: 11px;font-family: Arial;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OPERACION GRATUITA</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 12px;font-family: Arial;" align="right">' . number_format($descuento_temp, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 170;font-size: 11px;font-family: Arial;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OPERACION INAFECTA</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 12px;font-family: Arial;" align="right">' . number_format( $tot_opinafe, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 170;font-size: 11px;font-family: Arial;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OPERACION EXONERADA</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 12px;font-family: Arial;" align="right">' . number_format($tot_opexo, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 170;font-size: 11px;font-family: Arial;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$etiqueta_iva.' :</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 12px;font-family: Arial;" align="right">' . number_format($fact_iva, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

    
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 170;font-size: 11px;font-family: Arial;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IMPORTE TOTAL:</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 12px;font-family: Arial;" align="right">' . number_format($fact_tot_fact, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
        ...
        $totales .= '  <tr>
                            <td style="width: 220; font-size: 11px;font-family: Arial;" align="left" colspan="2">
                               '.$con_letra.' 
                            </td>
                        </tr>
                    </table>';
        ...
        $sqlFPago = "SELECT fx.fxfp_val_fxfp,   fx.fxfp_num_dias,   fp.fpag_des_fpag,   f.fact_val_tcam,    fx.fxfp_val_ext,    fm.mone_sgl_mone, f.fact_cm5_fac
                        ...
                        WHERE f.fact_cod_fact = fx.fxfp_cod_fact AND 
                                ...
                                --f.fact_cod_sucu = $idSucursal AND 
                                f.fact_cod_fact = $id ";
$tablePago = '<table style="width: 100%; margin-left:5px;margin-top:10px;">';
            ...
            if ($oIfx->NumFilas() > 0) {
                ...
                do {
                    ...
                    if ($mone_sgl_mone == 'USD') {
                        $tablePago .= '<tr>';
                        $tablePago .= '<td style="width: 170; padding: 0px;font-family: Arial; font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . htmlentities($fpag_des_fpag) . '<small><b>('.$fxfp_val_ext.')</b></small></td>';
                        $tablePago .= '<td style="width: 50; padding: 0px;font-family: Arial; font-size:12px;" align="right">'. number_format($fxfp_val_fxfp, 2, '.', '') . '</td>';
                        $tablePago .= '</tr>';
                    }else{
                        $tablePago .= '<tr>';
                        $tablePago .= '<td style="width: 170; padding: 0px;font-family: Arial; font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . htmlentities($fpag_des_fpag) . '</td>';
                        $tablePago .= '<td style="width: 50; padding: 0px;font-family: Arial; font-size:12px;" align="right">' . number_format($fxfp_val_fxfp, 2, '.', '') . '</td>';
                        $tablePago .= '</tr>';
                    }
                } while ($oIfx->SiguienteRegistro());
        ...
        $tablePago .= '<tr>';
        $tablePago .= '<td style="width: 170; padding: 0px;font-family: Arial; font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CAJERO</td>';
        $tablePago .= '<td style="width: 50; padding: 0px;font-family: Arial; font-size:12px;" align="right">'.$nombre_cajero.'</td>';
        $tablePago .= '</tr>';
        $tablePago .= '</table>';
        ...
        $html .= '<div style="width: 80mm; margin: 0px;margin-left:5px;" >'; //div 2
        ...
        $html .= '<table align="left" >
                    ...
                    <tr>
                        <td align="center" style="font-size: 11px;font-family: Arial;" width="220">
                            <b>' . $razonSocial . '</b>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="font-size: 11px;font-family: Arial; " width="200">' . $ruc_empr . '</td>
                    </tr>';
                ...
                $html.='<tr><td align="center" style="font-size: 11px; font-family: Arial; " width="200">
                        ...
                        <tr>
                        <td align="center" style="font-size: 11px;font-family: Arial; " width="200">' . $sucu_dir_sucu . '</td>
                    </tr>';


                    if(strlen($sucu_telf_sucu)>0){
                        $html.='<tr>
                                    <td align="center" style="font-size: 11px; font-family: Arial; " width="200">
                                        <b>Celular:</b> ' . $sucu_telf_sucu . '
                                    </td>
                                </tr>';
                    }
            ...
            $html.='<tr>
                        <td style="font-size: 11px; font-family: Arial;" colspan="2"  align="center" width="200"><br>'.$titulo.'</td>
                    </tr>';
                    if($para_punt_emi == 'S' && $valida_pais == '504'){
                        ...
                        $html.='<tr>
                                    <td style="font-size: 12px; font-family: Arial; width:40mm;" align="center" colspan="2" width="200"><b>' . $num_serie . '</b></td>
                                </tr>';
                    }else{
                        $html.='<tr>
                                    <td style="font-size: 12px; font-family: Arial; width:40mm;" align="center" colspan="2" width="200"><b>' . $fact_nse_fact . ' - ' . $fact_num_preimp . '</b></td>
                                </tr>';
                    }
                    $fact_fech_fact=date('d/m/Y', strtotime($fact_fech_fact));
            $html.='</table>
            <table align="left" ><tr>
                        <td style="font-size: 11px; font-family: Arial;" align="left"  width="140">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FECHA:</td>
                        <td style="font-size: 11px;font-family: Arial;" align="left"  width="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$fact_fech_fact . '
                        </td>
                    </tr>
                    <tr>
                    <td style="font-size: 11px; font-family: Arial;" align="left"  width="140">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HORA:</td>
                        <td style="font-size: 11px;font-family: Arial;" align="left"  width="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$fact_hor_fin.'
                        </td>
                    </tr>
                </table>';
        ...
        $html .= '<table align="left" style="margin-left:5px;" >
                    ...
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left"  width="240">'.$fact_nom_cliente.'</td>
                    </tr>
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;"  align="left"  width="230"><b>'.$tip_iden_cliente.': </b>&nbsp;&nbsp;&nbsp;' .$fact_ruc_clie. '</td>
                        
                    </tr>
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left" width="240">
                            <b>DIRECCION:</b>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left" " width="240"><div style="width: 55mm;">
                            '.$fact_dir_clie.'</div>
                        </td>
                    </tr>';
       ...
       /* $html .=    '<div style="margin: 0px; margin-left: 12px;;">
                        <br>
                        <table align="left">
                        <tr>
                            <td style="font-size: 11px;font-family: Arial;" align="left">
...
$tablePago = '<table style="width: 100%; margin-left:5px;margin-top:10px;">';
        ...
        if (!empty($posicion_coincidencia)) {
            ...
            $titulo="FACTURA DE VENTA ELECTRONICA";
            $tipo_envio='FACTURA';
            }
    ...
    $imageData = $bobj->getPngData(); // Obtenemos el resultado en formato PNG
     ...
     $ruta_dir = DIR_FACTELEC . 'modulos/int_facturacion/qr_facturas';
        if (!file_exists($ruta_dir)){
            mkdir($ruta_dir,0777,true);
        }

    file_put_contents('qr_facturas/REC_'.$id.'.png', $imageData); // Guardamos el resultado
    
    $ruta=DIR_FACTELEC . 'modulos/int_facturacion/qr_facturas/REC_'.$id.'.png';


        $tablePago .= '<tr>';
        $tablePago .= '<td style="width: 170; padding: 0px;font-family: Arial; font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CAJERO</td>';
        $tablePago .= '<td style="width: 50; padding: 0px;font-family: Arial; font-size:12px;" align="left">'.$nombre_cajero.'</td>';
        $tablePago .= '</tr>';
        $tablePago .= '<tr>'; 
        $tablePago .= '<td colspan="2" style="width: 170; font-family: Arial; font-size:11px;" align="center"><img src="'.$ruta.'"></td>';       
        $tablePago .= '</tr>';
        $tablePago .= '<tr>';
        $tablePago .= '<td colspan="2" style="width: 170; padding: 0px;font-family: Arial; font-size:11px;" align="center"><p>Presentación impresa del Comprobante Electrónico generada desde el sistema facturador SUNAT
        <br>Puede verificarla utilizando su clave SOL<br><br><b>YAPE</b>
        <br><b>951750407</b><br>Enviar captura a los números de la parte superior del comprobante</p></td>';        
        $tablePago .= '</tr>'; 
        $tablePago .= '</table>';
        ...
        $html .= '<table align="left" >
            ...
            $html.='<tr>
                    ...
                    if($para_punt_emi == 'S' && $valida_pais == '504'){
                        ...
                        $html.='<tr>
                                    <td style="font-size: 12px; font-family: Arial; width:40mm;" align="center" colspan="2" width="200"><b>' . substr($fact_nse_fact,3,9) . ' - ' . $fact_num_preimp . '</b></td>
                                </tr>';
                    }
                    $fact_fech_fact=date('d/m/Y', strtotime($fact_fech_fact));
            $html.='</table>
