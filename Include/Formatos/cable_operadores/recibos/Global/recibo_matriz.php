...
function formato_recibo($id, $cliente){
    ...
    if ($contador > 0) {
        ...
        if ($oIfx->Query($sqlFac)) {
            if ($oIfx->NumFilas() > 0) {
                do {
                    ...
                    if(empty($fact_cod_contr)||$fact_cod_contr==0){
                        $fact_cod_contr     = $oIfx->f("fact_cm7_fac");
                    }
        ...
        $deta = ' <table style="width: 100%;" >
                    <tr>
                        <td colspan="2" style="border-top: 1px solid black;" width="200"></td>
                    </tr>';
        $deta .= ' <tr>';
        $deta .= ' <b> <td style="width: 150; font-size: 7px;font-family: Arial;" align="center">CONCEPTO</td> </b>';
        $deta .= ' <b> <td style="width: 50; font-size: 7px;font-family: Arial;" align="center">IMPORTE</td> </b>';
        $deta .= ' </tr>
                    <tr>
                        <td colspan="2" style="border-top: 1px solid black;" width="200"></td>
                    </tr>';
        ...
        if ($oIfx->Query($sqlDeta)) {
            if ($oIfx->NumFilas() > 0) {
                ...
                elseif($dfac_obj_iva ==1 && $dfac_exc_iva!=1){
                    ...
                    $deta .= ' <tr>';
                    $deta .= ' <td style="width: 150;font-family: Arial; font-size: 7px;">' . $dfac_det_dfac . '</td>';
                    $deta .= ' <td style="width: 50; font-family: Arial; font-size: 7px;" align="right">' . number_format($dfac_precio_dfac, 2, '.', ',') . '</td>';
                    $deta .= ' </tr>';
                ...
                $deta .= ' <tr>';
                $deta .= ' <td style="width: 150;font-family: Arial; font-size: 7px;" align="justify">' . $fact_cm1_fact . '</td>';
                $deta .= ' <td style="width: 50; font-family: Arial; font-size: 7px;" align="right"></td>';
                $deta .= ' </tr>';
         ...
         if($fact_cod_mone==$pcon_seg_mone)
    {
        ...
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 150;font-size: 7px;font-family: Arial;">OP. GRAVADA</td></b>';
        $totales .= ' <td style="width: 50;font-size: 7px;font-family: Arial;" align="right">' . number_format($tot_opgrav, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';


        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 150;font-size: 7px;font-family: Arial;">OP. INAFECTA</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 7px;font-family: Arial;" align="right">' . number_format( $tot_opinafe, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 150;font-size: 7px;font-family: Arial;">OP. EXONERADA</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 7px;font-family: Arial;" align="right">' . number_format($tot_opexo, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 150;font-size: 7px;font-family: Arial;">'.$etiqueta_iva.' :</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 7px;font-family: Arial;" align="right">' . number_format($fact_iva, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';


        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 150;font-size: 7px;font-family: Arial;">IMPORTE TOTAL:</td> </b>';
        $totales .= ' <td style="width: 50;font-size: 7px;font-family: Arial;" align="right">' . number_format($fact_tot_fact, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
        ...
        <tr>
                ...
                <table align="left" >
                    <tr>
                        <td style="font-size: 7px;font-family: Arial;" align="left" width="55"><b>CONTRATO:</b></td>
                        <td style="font-size: 7px;font-family: Arial;" align="left" width="145">'.$codigo_clpv.'</td>
                    </tr>
                    <tr>
                        <td style="font-size: 7px;font-family: Arial;" align="left" width="55"><b>MONEDA:</b></td>
                        <td style="font-size: 7px;font-family: Arial;" align="left" width="145">'.$moneda.'</td>
                    </tr>
                    <tr>
        ...
        $html .=    '
                        ...
                        <tr>
                            <td style="font-size: 7px;font-family: Arial;" align="left" width="130"><b>SALDO:</b></td>
                            <td style="font-size: 7px;font-family: Arial;"  align="left" width="80">'.number_format($deuda, 2, '.', ',') . '</td>
                        </tr>
                        <tr>
...
function formato_recibo_elec($id, $cliente){
    ...
    $ruta=DIR_FACTELEC . 'modulos/int_facturacion/qr_facturas/REC_'.$id.'.png';
        ...
        $html .=    '
                        ...
                        <tr>
                            <td style="font-size: 7px;font-family: Arial;" align="center" colspan="2" width="200">Representación impresa de la '.$titulo.'
                            <br>Consulta tu comprobante en: <a href ="www.sunat.gob.ec" target="_blank"><b>www.sunat.gob.pe</b></a>
                            </td>
                        </tr>
                        </table>
