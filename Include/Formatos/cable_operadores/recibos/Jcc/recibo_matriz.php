...
function formato_recibo($id, $cliente){
    ...
    if ($oIfx->Query($sqlFac)) {
        if ($oIfx->NumFilas() > 0) {
            do {
                ...
                $tcmp_des_tcmp = 'FACTURA ELECTRONICA';//;consulta_string_func($sql, 'tcmp_des_tcmp', $oIfxA, '');
    ...
    $deta .= ' <tr  style="">';
    $deta .= ' <b> <td style="font-size: 11px;font-family: Arial;" align="center">CANT</td> </b>';
    $deta .= ' <b> <td style="font-size: 11px;font-family: Arial;" align="center">DESCRIPCIÓN</td> </b>';
    $deta .= ' <b> <td style="font-size: 11px;font-family: Arial;" align="center">IMPORTE</td> </b>';
    $deta .= ' </tr>
                <tr>
                    <td colspan="3" style="border-top: 1px solid black;"></td>
                </tr>';
    ...
    if ($oIfx->Query($sqlDeta)) {
        if ($oIfx->NumFilas() > 0) {
            ...
            do {
                ...
                $deta .= ' <tr>';
                $deta .= ' <td style="width: 10%; padding: 8px;font-family: Arial; font-size:12px;" align="right">' . round($dfac_cant_dfac) . '</td>';
                $deta .= ' <td style="width: 40%; padding: 8px;font-family: Arial; font-size:12px;">' . $dfac_det_dfac . '</td>';
                $deta .= ' <td style="width: 10%; padding: 8px;font-family: Arial; font-size:12px;" align="right">' . number_format($dfac_mont_total, 2, '.', ',') . '</td>';
                $deta .= ' </tr>';
    ...
    $totales = ' <table style="width: 120%; margin: 7px;">';

    if($empr_cod_pais == 23){
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">Descuentos o Rebajas <br> otorgados: <b>'.$moneda_emp_local_sm.'.</b></td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format($descuento_temp, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">Importe exonerado: <b></b></td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format(0, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">Importe exento: <b></b></td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format(0, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">Importe gravado' . round($porcIva) . '%: '.$moneda_emp_local_sm.'.<b></b></td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format($fact_tot_fact - $fact_ice - $fact_iva, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">Importe gravado 18%: '.$moneda_emp_local_sm.'.<b></b></td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format(0, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
    }else{
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">SUBTOTAL '.$moneda_emp_local_sm.' ' . round($porcIva) . '%: <b></b></td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format($fact_tot_fact - $fact_ice - $fact_iva, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">SUBTOTAL '.$moneda_emp_local_sm.' 0%: <b></b></td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format($fact_sin_miva, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
    }

    if($empr_cod_pais != 23){
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">DESCUENTO <b>'.$moneda_emp_local_sm.':</b></td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format($descuento_temp, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
    }
    
    $totales .= ' <tr>';
    $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">'.$etiqueta_iva.' '.$porcentaje_iva.'%:</td> </b>';
    $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format($fact_iva, 2, '.', ',') . '</td>';
    $totales .= ' </tr>';

    if($empr_cod_pais == 23){
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">'.$etiqueta_iva.' 18%:</td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format(0, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
    }
    ...
    if($empr_cod_pais == 1){
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">ICE 15%:</td> </b>';
        $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format($fact_ice, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
    }

    $totales .= ' <tr>';
    $totales .= ' <b> <td style="font-size: 11px;font-family: Arial;">TOTAL: <b>'.$moneda_emp_local_sm.'.</b></td> </b>';
    $totales .= ' <td style="font-size: 11px;font-family: Arial;" align="right">' . number_format($fact_tot_fact, 2, '.', ',') . '</td>';
    $totales .= ' </tr>';
    ...
    $V = new EnLetras();
    $con_letra = strtoupper($V->ValorEnLetras($fact_tot_fact, $moneda_des_mone.$txt));
    
    $totales .= '  <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left" colspan="3">
    ...
    if ($oIfx->Query($sqlFPago)) {
        if ($oIfx->NumFilas() > 0) {
            $tablePago = '<table style="width: 60%; margin: 0px;">';
            $tablePago .= '<tr >';
            $tablePago .= '<b><td style="width: 85%; padding: 0px;font-family: Arial; font-size:12px;">FORMA PAGO</td></b>';
            $tablePago .= '<b><td style="width: 17%; padding: 0px;font-family: Arial; font-size:12px;">VALOR</td></b>';
            $tablePago .= '</tr>';
            do {
                ...
                if ($mone_sgl_mone == 'USD') {
                    $tablePago .= '<tr>';
                    $tablePago .= '<td style="width: 70%; padding: 0px;font-family: Arial; font-size:12px;">' . htmlentities($fpag_des_fpag) . '<small><b>('.$fxfp_val_ext.')</b></small></td>';
                    $tablePago .= '<td style="width: 20%; padding: 0px;font-family: Arial; font-size:12px;">'. number_format($fxfp_val_fxfp, 2, '.', '') . '</td>';
                    $tablePago .= '</tr>';
                }else{
                    $tablePago .= '<tr>';
                    $tablePago .= '<td style="width: 80%; padding: 0px;font-family: Arial; font-size:12px;">' . htmlentities($fpag_des_fpag) . '</td>';
                    $tablePago .= '<td style="width: 20%; padding: 0px;font-family: Arial; font-size:12px;">' . number_format($fxfp_val_fxfp, 2, '.', '') . '</td>';
                    $tablePago .= '</tr>';
                }
            } while ($oIfx->SiguienteRegistro());
    ...
    $html .= '<div style="width: 80mm; margin: 7px; height: 155mm;" >'; //div padre

    $html .= '<div style="width: 80mm; margin: 0px;">'; //div 2
    
    $html .= '<table align="left">
                <tr>
                    <td style="margin-top: 0px; padding: 15px;"" align="center">
                        '.$logo_empresa.'
                    </td>
                </tr>
                <tr>
                    <td align="center" style="text-align:center;font-family: Arial;">
                        <h4 style="margin: 0px; font-size: 9px; ">' . htmlentities(substr($razonSocial, 0, 18)) . '</h4>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="text-align:center;font-family: Arial;">
                        <h4 style="margin: 0px; font-size: 9px; ">' . htmlentities(substr($razonSocial, 18, strlen($razonSocial))) . '</h4>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="font-size: 11px;font-family: Arial; ">
                        <b>'.$tip_ruc_pais.':</b> ' . $ruc_empr . '
                    </td>
                </tr>
                <tr>
                    <td align="center" style="font-size: 11px; font-family: Arial;">
                ...
                <tr>
                    <td style="font-size: 11px;font-family: Arial; text-align: justify;"><div style="width: 55mm;">
                        '.$dirMatriz.'</div>
                    </td>
                </tr>
                <tr>
        ...
        if($empr_cod_pais != 23){
            $html.='<tr><td align="center" style="font-size: 11px; font-family: Arial; width:40mm;">
                        <b>SUCURSAL:</b> ' . substr(htmlentities($sucu_nom_sucu),0,15) . '
                        </td>
                    </tr>';
        }
                if(strlen($empr_tel_resp)>0){
                    $html.='<tr>
                                <td align="center" style="font-size: 11px; font-family: Arial; width:40mm;">
                ...
                if($empr_cod_pais == 23){
                    $html.='<tr><td align="center" style="font-size: 11px; font-family: Arial; width:40mm;">
                            ...
                            <tr><td align="center" style="font-size: 11px; font-family: Arial; width:40mm;">
        ...
        $html.='<tr>
                    <td style="font-size: 11px; font-family: Arial;" colspan="2"  align="center"><b>'.$titulo.'</b></td>
                </tr>
                <tr>
                    <td style="font-size: 12px; font-family: Arial; width:40mm;" align="center" colspan="2">' . $fact_nse_fact . ' - ' . $fact_num_preimp . '</td>
                </tr>
                <tr>
                    <td style="font-size: 11px; font-family: Arial;" align="center" colspan="2">
    ...
    $html .= '<table align="left">
                <tr>
                    <td style="font-size: 11px;font-family: Arial;" align="left" colspan="2">
                        <b>Cajero:</b>
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 11px;font-family: Arial;" align="left" colspan="2"><div style="width: 55mm;">
                        '.htmlentities($nombre_cajero).'</div>
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 11px;font-family: Arial;" align="left">
                        <b>Moneda:</b>
                    </td>
                    <td style="font-size: 11px;font-family: Arial;" align="left">
                        ' . $moneda_des_mone . '
                ...
                <tr>
                    <td style="font-size: 11px;font-family: Arial;" align="left" colspan="2"><div style="width: 55mm;">
                        '.htmlentities($fact_nom_cliente).' / '.$fact_cod_contr.'-2</div>
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 11px;font-family: Arial;" align="left">
                        <b>'.$tip_iden_cliente.':</b>
                    </td>
                    <td style="font-size: 11px;font-family: Arial;" align="left">
                        ' . htmlentities($fact_ruc_clie) . '
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 11px;font-family: Arial;" align="left" colspan="2">
                ...
                <tr>
                    <td style="font-size: 11px;font-family: Arial;" align="left" colspan="2"><div style="width: 48mm;">
                        '.$observacion.'</div>
                    </td>
                </tr>
            </table> ';
    ...
    $html .=    '<div style="margin: 0px; margin-left: 2mm;">
                    <br>
                    <table align="left">
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left">
                        ...
                        <td style="font-size: 10px;" width:100px;" align="right">' . number_format($deuda, 2, '.', ',') . '</td>
                    </tr>';
                    ...
                    //VALIDAICON FACTURA AUTORIZADAS
                    $fec_auto='';
                    if($fact_aprob_sri=='S'){
                        $fec_auto='<br>Fecha de Autorización:<br>'.$fact_fech_sri.'<br>Clave de Acceso:<br>'.substr($fact_clav_sri,0,25).'<br>'.substr($fact_clav_sri,25,30).'<br>'; 
                    }
    $html .=    '<tr>
                        <td style="font-size: 11px;" align="center" colspan="2"></td>
                    </tr>
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="center" colspan="2"></td>
                    </tr>
                    <br>
                    <br>
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="center" colspan="2" width="230">
                            '.$fec_auto.'<br>
                            <b>Nota:</b> Para la atención de reclamos NO resueltos por el prestador ingrese su reclamo al link https://reclamoconsumidor.arcotel.gob.ec/osTicket/, o para mayor información comuníquese al 1800 567-567
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size: 11px;" align="center" colspan="2"></td>
...
function formato_recibo_elec($id, $cliente){
    ...
    if ($contador > 0) {
        ...
        $deta = ' <table style="width: 100%;" style="margin-left:12px;">
                    <tr>
                        <td colspan="3" style="border-top: 1px solid black;"></td>
                    </tr>';
        $deta .= ' <tr>';
        $deta .= ' <b> <td style="width: 10%; font-size: 11px;font-family: Arial;" align="center">CANT</td> </b>';
        $deta .= ' <b> <td style="width: 40%; font-size: 11px;font-family: Arial;" align="center">DESCRIPCIÓN</td> </b>';
        $deta .= ' <b> <td style="width: 10%; font-size: 11px;font-family: Arial;" align="center">IMPORTE</td> </b>';
        $deta .= ' </tr>
                    <tr>
                        <td colspan="3" style="border-top: 1px solid black;"></td>
                    </tr>';
        ...
        if ($oIfx->Query($sqlDeta)) {
            if ($oIfx->NumFilas() > 0) {
                ...
                do {
                    ...
                    $deta .= ' <tr>';
                    $deta .= ' <td style="width: 10%; padding: 8px;font-family: Arial; font-size:12px;" align="right">' . round($dfac_cant_dfac) . '</td>';
                    $deta .= ' <td style="width: 90px; padding: 8px;font-family: Arial; font-size:12px;">' . $dfac_det_dfac . '</td>';
                    $deta .= ' <td style="width: 10%; padding: 8px;font-family: Arial; font-size:12px;" align="right">' . number_format($dfac_mont_total, 2, '.', ',') . '</td>';
                    $deta .= ' </tr>';
        ...
        $totales = ' <table style="width: 120%; margin: 7px;margin-left:12px;">';
        ...
        if ($oIfx->Query($sqlFPago)) {
            if ($oIfx->NumFilas() > 0) {
                $tablePago = '<table style="width: 60%; margin: 0px;margin-left:12px;">';
                $tablePago .= '<tr >';
                $tablePago .= '<b><td style="width: 85%; padding: 0px;font-family: Arial; font-size:12px;">FORMA PAGO</td></b>';
                $tablePago .= '<b><td style="width: 17%; padding: 0px;font-family: Arial; font-size:12px;">VALOR</td></b>';
                $tablePago .= '</tr>';
        ...
        $html .= '<div style="width: 80mm; margin: 0px;margin-left:12px;" >'; //div 2
        
        $html .= '<table align="left">
                    <tr>
                        <td style="margin-top: 0px; padding: 15px;"" align="center" width="200">
                        '.$logo_empresa.'
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="text-align:center;font-family: Arial;" width="190">
                            <h4 style="margin: 0px; font-size: 9px; ">' . htmlentities(substr($razonSocial, 0, 20)) . '</h4>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="text-align:center;font-family: Arial;" width="190">
                            <h4 style="margin: 0px; font-size: 9px; ">' . htmlentities(substr($razonSocial, 20, strlen($razonSocial))) . '</h4>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="font-size: 11px;font-family: Arial; " width="200">
                            <b>'.$tip_ruc_pais.':</b> ' . $ruc_empr . '
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="font-size: 11px;font-family: Arial; text-align: center;" width="200">
                            '.$dirMatriz.'
                        </td>
                    </tr>
                    <tr>
            ...
            if($valida_pais != '504'){
                $html.='<tr><td align="center" style="font-size: 11px; font-family: Arial; " width="200">
                            <b>SUCURSAL:</b> ' . substr(htmlentities($sucu_nom_sucu),0,15) . '
                            </td>
                        </tr>';
            }
                    ...
                    if($valida_pais == '504'){
                        $html.='<tr><td align="center" style="font-size: 11px; font-family: Arial; " width="200">
                                ...
                                <tr><td align="center" style="font-size: 11px; font-family: Arial; " width="200">
                                    <b>FACEBOOK:</b> ' . $empr_ema_comp . '
                                    </td>
                                </tr>
                                ';
            ...
            $html.='<tr>
                        <td style="font-size: 11px; font-family: Arial;" colspan="2"  align="center" width="200"><b>'.$titulo.'</b></td>
                    </tr>';
            ...
            $html.='<tr>
                        <td style="font-size: 11px; font-family: Arial;" align="center" colspan="2" width="200">
                            <b>Fecha y Hora de Emisión: </b>
                        </td>
                    </tr>
                    <tr>
        ...
        $html .= '<table align="left" style="margin-left:12px;">
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left" colspan="2">
                            <b>Cajero:</b>
                        </td>
                    ...
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left" colspan="2" width="230"><div style="width: 55mm;">
                            '.htmlentities($fact_nom_cliente).' / '.$fact_cod_contr.'-1</div>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left">
                    ...
                    <tr>
                        <td style="font-size: 11px;font-family: Arial;" align="left" colspan="2" width="230"><div style="width: 48mm;">
                            '.$observacion.'</div>
                        </td>
                    </tr>
                </table> ';
