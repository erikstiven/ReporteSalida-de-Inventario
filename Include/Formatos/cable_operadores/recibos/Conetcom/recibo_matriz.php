...
function formato_recibo($id, $cliente){
    ...
    if ($contador > 0) {
        ...
        $deta = ' <table style="width: 85%;">
                    <tr>
                        <td colspan="2" style="border-top: 1px solid black;"  width="150"></td>
                    </tr>';
        $deta .= ' <tr>';
        $deta .= ' <b> <td style="width: 130; font-size: 9px;font-family: Arial;" align="center">DESCRIPCION</td> </b>';
        $deta .= ' <b> <td style="width: 20; font-size: 9px;font-family: Arial;" align="center">C</td> </b>';
        //$deta .= ' <b> <td style="width: 50; font-size: 9px;font-family: Arial;" align="center">IMPORTE</td> </b>';
        $deta .= ' </tr>
                    <tr>
                        <td colspan="2" style="border-top: 1px dashed;"></td>
                    </tr>';
        ...
        if ($oIfx->Query($sqlDeta)) {
            if ($oIfx->NumFilas() > 0) {
                ...
                do {
                    ...
                    $deta .= ' <td style="width: 20;  font-family: Arial; font-size: 9px;" align="center">' . round($dfac_cant_dfac) . '</td>';
        ...
        $totales = ' <table style="width: 85%;">';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 130;font-size: 9px;font-family: Arial;">GRAND TOTAL:</b>';
        $totales .= ' <td style="width: 50;font-size: 9px;font-family: Arial;" align="right">'.$moneda_emp_local_sm.' ' . number_format($fact_tot_fact, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';


        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 130;font-size: 9px;font-family: Arial;">SALDO PENDIENTE: </td> </b>';
        $totales .= ' <td style="width: 50;font-size: 9px;font-family: Arial;" align="right">'.$moneda_emp_local_sm.' ' . number_format(0, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 130;font-size: 9px;font-family: Arial;">SU PAGO: </td> </b>';
        $totales .= ' <td style="width: 50;font-size: 9px;font-family: Arial;" align="right">'.$moneda_emp_local_sm.' ' . number_format($fact_tot_fact, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 130;font-size: 9px;font-family: Arial;">SALDO ACTUAL: <b>'.$fact_fech_fact.' '.$fact_hor_fin.'</b></td> </b>';
        $totales .= ' <td style="width: 50;font-size: 9px;font-family: Arial;" align="right">'.$moneda_emp_local_sm.' ' . number_format($deuda, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
        ...
        $html .= '<table align="left">
                    <tr>
                        <td align="center" style="font-size: 12px; font-family: Arial;" width="255"><b>' . $razonSocial . '</b></td>
                    </tr>

                    <tr>
                        <td align="center" style="font-size: 9px;font-family: Arial; " width="255">
                            RIF: ' . $ruc_empr . ' '.$empr_tel_resp.'
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="font-size: 9px; font-family: Arial;" width="255">
                    ...
                    <tr>
                        <td style="font-size: 9px;font-family: Arial; text-align: center;" width="255">
                            '.$dirMatriz.'
                        </td>
                    </tr>';                   
                        $html.='<tr>
        ...
        $html .= '<table align="left" >
                    <tr>
                        <td colspan="2" style="font-size: 9px;font-family: Arial;" align="left" width="210"><b>CLIENTE:</b> '.$fact_nom_cliente.'</td>
                    </tr>
                    
                    <tr>
                        <td colspan="2" style="font-size: 9px;font-family: Arial;" align="left" width="210"><b>FORMA DE PAGO:</b> '.$fpag_des_fpag.'</td>
                    </tr>
                    <tr>
                    <td colspan="2" style="font-size: 9px;font-family: Arial;" align="left" width="210"><b>ESTADO:</b> Pagada</td>
                    </tr>
                    <tr>
                        <td style="font-size: 9px;font-family: Arial;" align="left" width="165"><b>FECHA DE PAGO: '.$fact_fech_fact.' '.$fact_hor_fin.'</b></td>
                        <td style="font-size: 9px;font-family: Arial;" align="right" width="90"><b>RECIBO N°' . intval($fact_num_preimp) . '</b> </td>
                    </tr>
        ...
        $html .=    ' <tr> <td style="font-size: 9px;font-family: Arial;"  colspan="2"><b>CAJERO:</b>'.$nombre_cajero.'</td>
                    </tr>
                        <tr>
