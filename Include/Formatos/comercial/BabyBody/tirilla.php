...
function formato_tirilla($id, $tipo)
{
    ...
    if ($contador > 0) {
        ...
        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 150;font-size: 7px;font-family: Arial;">SUBTOTAL ' . $porcentaje . ' %:</td></b>';
        $totales .= ' <td style="width: 50;font-size: 7px;font-family: Arial;" align="right">' . number_format($fact_con_miva , 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <b> <td style="width: 150;font-size: 7px;font-family: Arial;">SUBTOTAL 0%:</td></b>';
        $totales .= ' <td style="width: 50;font-size: 7px;font-family: Arial;" align="right">' . number_format($fact_sin_miva, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
