...
function rol_individual_formato($id_empresa = 0, $id_anio = 0, $id_mes = 0, $id_empl = '', $id_depar = 0, $id_proyecto = 0, $tipo_formato=0)
{
    ...
    $sql="SELECT   empl_cod_empl, empl_ape_nomb, empl_cod_eemp,empl_cod_pdie  FROM saeempl
                ...
                if ($oIfx->Query($sql)) {
                                ...
                                if ($oIfx->NumFilas() > 0) {
                                    do {
                                        ...
                                        if ($rubr_cod == 'RSUEL') {
                                            ...
                                            $dias_tra = (($empl_jor_trab-$hor_vaca-$hor_efer-$hor_lice-$hor_sein)*30/$empl_jor_trab);
                    ...
                    if ($oIfx->Query($sql)) {
                        ...
                        $oIfx->Free();
                            ...
                            $table_rol = '<br><table  align="left" border="0"   style="width: 100%;  margin-top: 0px; font-size:14px;" >';
                            $table_rol .= '<tr>';
                            ...
                            $table_rol .= '<br><br><table align="left" border="0" style="width: 100%; font-size:10px;border:2px solid black; ">';
                             $table_rol .='<tr>
                            ...
                            $table_rol .='<tr>
                                     ...
                                     <td align="right">'.number_format($empl_jor_trab, 2, '.', ',').'</td>
                                  </tr>';
                            ...
                            <td align="right">'.number_format(($dias_tra+$dias_vaca+$dias_efer+$dias_lice_sin_goce+$dias_lice), 2, '.', ',').'</td>
                            <td ></td>
                            <td align="right"></td>
                         </tr>';
...
//INGRESOS , DESCUENTOS , APORTES DEL EMPLEADOR
                            ...
                            $table_rol .= '<br><br><table style="width: 100%; font-size:9px; margin-top: 10px;" border="0" cellspacing="0" cellpadding="0">';
                            $table_rol .= '<tr>
                            ...
                            $table_rol .= '<tr>
                                        <td valign="top" width = "33.33%"><br><br><table  style="width: 100%;" border="1" cellspacing="1" cellpadding="1">        
                                                <tr>
                            ...
                            $table_rol .= '<br><br><table style="width: 100%;" border="0" >';
                            $table_rol .= '<tr>
                                                <td  valign="top" width="33.33%"></td>
                                                <td  valign="top " width="33.33%"><table  style="width: 100%;" border="1" >         
                                                                <tr>
                ...
                $legend .= ' <br><br><br><br>
                        <table style="width: 100%; " border="0" >
                            <tr>
                                ...
                                '.$jefe_rrh.'<br>JEFE RRHH
                                    
                                </td>
                                <td style="width: 50%;" align="center">
                                <strong>______________________________________________________</strong><br>
                                        RECIBÍ CONFORME : ' . $empl_nom . '
                                </td>
                            </tr>
                    </table><br><br>';
