...
//echo $monto;exit;
  ...
  if(preg_match("/INTERNACIONAL/i",$formato)||preg_match("/PRODUBANCO/i",$formato)|| preg_match("/PICHINCHA/i",$formato)||preg_match("/GUAYAQUIL/i",$formato)||preg_match("/PACIFICO/i",$formato)||preg_match("/BOLIVARIANO/i",$formato)){
	...
	$log = strlen($beneficiario);
	  ...
	  for($log; $log<=100; $log++){
		...
		if($log == 100){
		 ...
		 $tablePDF='<table border="0" style="width: 100%; margin: 10px;  margin-top: 7px;">
					   <tr >
							<td style=" width: 65%; height: 12px; font-size:10px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width:25%; height: 12px; font-size:10px;" >**'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr style="m">
							<td style="width: 100%; height: 10px; font-size:10px;" colspan="2"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
						</tr>
						<tr   >
							<td colspan="2" style="width: 100%;height: 11px; font-size:12px; " > xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxx </td>
						</tr>
						<tr>
	...
	$html.='<page backimgw="10%" backtop="6mm" backbottom="12mm" backleft="19mm" backright="4mm">';
	$html.=$tablePDF;
	$html.= '</page>';
