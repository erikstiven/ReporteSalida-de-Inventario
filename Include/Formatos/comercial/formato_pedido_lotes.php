...
//    print_r($sqlPed);
    if ($oIfx->Query($sqlPed)) {
        ...
        if ($oIfx->NumFilas() > 0) {
                ...
                $cliente .= ' <td style="width: 30%;">' . $fecha_user . ' '.$pedf_hor_fin.'</td>';
                $cliente .= ' </tr>';
    ...
    $deta .= ' <b> <th class="diagrama" style="width: 16%;" align="center">DESCRIPCION</th> </b>';
    $deta .= ' <b> <th class="diagrama" style="width: 8%;" align="center">DETALLE</th> </b>';
    $deta .= ' <b> <th class="diagrama" style="width: 8%;" align="center">APLICACION</th> </b>';
    ...
    $deta .= ' <b> <th class="diagrama" style="width: 7%;" align="center">CANT</th> </b>';
    $deta .= ' <b> <th class="diagrama" style="width: 5%;" align="center">PREC</th> </b>';
    $deta .= ' <b> <th class="diagrama" style="width: 5%;" align="center">DSCT</th> </b>';
    $deta .= ' <b> <th class="diagrama" style="width: 5%;" align="center">TOTAL</th> </b>';
    $deta .= ' </tr>';
    ...
    if ($oIfx->Query($sqlDeta)) {
        if ($oIfx->NumFilas() > 0) {
            ...
            do {
                ...
                $sql_apli="select prod_apli_prod from saeprod where prod_cod_prod='$dfac_cod_prod'";
                $aplicacion = consulta_string($sql_apli, 'prod_apli_prod', $oIfxA, '');
				...
				$dpef_lote_fcad = $oIfx->f('dpef_lote_fcad');
                ...
                $deta .= ' <td style="width: 12%;" align="center">' . $dfac_cod_prod . '</td>';
                $deta .= ' <td style="width: 16%;" align="left">' . ($dfac_nom_prod) . '</td>';
                $deta .= ' <td style="width: 8%;" align="left">' . ($dpef_det_dpef) . '</td>';
                $deta .= ' <td style="width: 8%;" align="left">' . $aplicacion . '</td>';
                ...
                $deta .= ' <td style="width: 7%;" align="center">' . round($dfac_cant_dfac, 0) . '</td>';
                $deta .= ' <td style="width: 5%;" align="center">' . number_format($dfac_precio_dfac, 4, '.', ',') . '</td>';
                $deta .= ' <td style="width: 5%;" align="center">' . round($dfac_des1_dfac, 0) . ' %</td>';
                $deta .= ' <td style="width: 5%;" align="center">' . number_format($dfac_mont_total, 4, '.', ',') . '</td>';
                $deta .= ' </tr>';
                $i++;
            }while ($oIfx->SiguienteRegistro());
        }
