...
//FECHA DE DEL PEDIDO
    $sfecha = "select pedi_fec_pedi, pedi_det_pedi, pedi_uso_pedi, pedi_lug_entr, pedi_cod_sucu from saepedi where pedi_cod_pedi='$pedi' and pedi_cod_empr=$idempresa and pedi_cod_sucu=$idsucursal";
    $fecha_pedido = consulta_string_func($sfecha, 'pedi_fec_pedi', $oIfx, '');
    $smotivo = consulta_string_func($sfecha, 'pedi_det_pedi', $oIfx, '');
    $suso = consulta_string_func($sfecha, 'pedi_uso_pedi', $oIfx, '');
        ...
        if ($oIfx->NumFilas() > 0) {
            ...
            from saeccosn where ccosn_cod_ccosn= '$cos'";
                ...
                $des .= ' <tr >
                            ...
                            <td style="font-size:90%;"align="center" width="20%">' . $citem . '<br></td>
                            <td style="font-size:90%;"align="left" width="40%">' . $nom_prod . '<br></td>
                            <td style="font-size:90%;"align="center" width="7%"> ' . $sigla . '<br></td>
                            <td style="font-size:90%;"align="center" width="7%"> ' . $cantidad . '<br></td>
                            <td style="font-size:90%;"align="left" width="22%"> ' . $detaprod . '<br></td>';
                $des .= '</tr>';
                $i++;
                $cont++;
...
<table border="0" style="width: 80%; margin-left: 100px;">
    <tr>
        <td style="width: 90%; font-size:10px; text-align: left"><strong>SOLICITADO POR: </strong> $slugar </td>
    </tr>    
    <tr>
    ...
    <tr>
        <td style="width: 90%; font-size:10px; text-align: left"><strong>DESCRIPCIÓN: </strong> $suso </td>
    </tr>
    <tr>
...
<table  border="0"  cellpadding="0">
    ...
    <td style="font-size:80%;" align="center" width="20%">
        <table cellspacing="2">
            ...
            <tr>
                <td align="center"><strong>Solicitado Por</strong></td>
            </tr>
            <tr>
                <td align="center"> $slugar </td>
            </tr>
        </table>    
    </td>
    <td style="font-size:80%;" align="center" width="20%">
        <table cellspacing="2">
            ...
            <tr>
                <td align="center">Ing. OSCAR RAMIREZ AYALA</td>
            </tr>
        </table>    
    </td>
    ...
    <td style="font-size:80%;" align="center"  width="20%">
        <table cellspacing="2">
            ...
            <tr>
                <td align="center">ABG. JHANELA SANMARTIN</td>
            </tr>
        </table>    
     </td>
     <td style="font-size:80%;" align="center"  width="20%">
     <table cellspacing="2">
         ...
         <tr>
             <td align="center"><strong>Directos Minero ZS</strong></td>
         </tr>
         <tr>
            <td align="center">AB. EDGAR VEGA</td>
        </tr>         
     </table>    
    </td>
    </tr>
