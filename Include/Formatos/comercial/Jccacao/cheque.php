...
//echo $monto;exit;
  ...
  ////
   if(preg_match("/PRODUBANCO/i",$formato)||preg_match("/GUAYAQUIL/i",$formato)||preg_match("/PACIFICO/i",$formato)||preg_match("/BOLIVARIANO/i",$formato)){
   ...
   if(preg_match("/PICHINCHA/i",$formato)){
	...
	$beneficiario=substr($beneficiario,0,48);
		 $tablePDF='<table border="0" style="font-family:dejavusans; width: 100%; margin: 0px;  margin-top: 34px;">
					   <tr >
							<td style=" width: 72%; height: 25px; font-size:11px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width: 28%; height: 25px; font-size:12px;" >'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr >
							<td style="width: 100%; height: 14px; font-size:11px;" colspan="2" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 18px; font-size:12px; " >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxx</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 8px; font-size:11px; "  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ciudad.','.$fecha.'</td>
						</tr>
					</table>';
	$html.='<page backimgw="10%" backtop="3mm" backbottom="10mm" backleft="30mm" backright="10mm">';
	$html.=$tablePDF;
	$html.= '</page>';	

   }

   if(preg_match("/MACHALA/i",$formato)){
	...
	$beneficiario=substr($beneficiario,0,48);
		 $tablePDF='<table border="0" style="font-family:dejavusans; width: 100%; margin: 0px;  margin-top: 38px;">
					   <tr >
							<td style=" width: 72%; height: 23px; font-size:11px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width: 28%; height: 23px; font-size:12px;" >'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr style="m">
							<td style="width: 100%; height: 14px; font-size:11px;" colspan="2" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
						</tr>
   ...
   if(preg_match("/PROCREDIT/i",$formato)){
	...
	//IMPRESORA EPSON L3250 FIREFOX - A4 MARGENES PREDETERMINADO 
