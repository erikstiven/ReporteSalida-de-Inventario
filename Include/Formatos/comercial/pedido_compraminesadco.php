        ...
        if ($oIfx->NumFilas() > 0) {
            ...
            from saeccosn where ccosn_cod_ccosn= '$cos'";
                ...
                $des .= ' <tr >
                            ...
                            <td style="font-size:90%;"align="center" width="10%">' . substr($citem, 0, 8) . '</td>
                            <td style="font-size:90%;"align="left" width="50%">' . $nom_prod . '</td>
...
<table  border="0"  cellpadding="0">
    <tr>
        ...
        <td style = "font-size:90%;" align="center" width="10%;" border="1px;"> <strong>CODIGO</strong></td>
        <td style = "font-size:90%;" align="center" width="50%;" border="1px;"> <strong>PRODUCTO</strong></td>
    ...
    <td style="font-size:80%;" align="center" width="20%">
        <table cellspacing="15">
            ...
            <tr>
                <td align="center"><strong> ______________ </strong></td>
            </tr>
            <tr>
                <td align="center"><strong>Gerente Administrativo</strong></td>
            </tr>
            <tr>
                <td align="center">AB. EDGAR FABIAN VEGA MACHUCA</td>
            </tr>
        </table>    
    </td>
    ...
    <td style="font-size:80%;" align="center"  width="20%">
     ...
     <table cellspacing="15">
         ...
         <tr>
             <td align="center"><strong>Gerente de Logistica</strong></td>
         </tr>
         <tr>
            <td align="center"></td>
        </tr>         
