...
//FECHA DE DEL PEDIDO
    $sfecha = "select pedi_fec_pedi, pedi_uso_pedi, pedi_lug_entr, pedi_cod_sucu from saepedi where pedi_cod_pedi='$pedi' and pedi_cod_empr=$idempresa and pedi_cod_sucu=$idsucursal";
    $fecha_pedido = consulta_string_func($sfecha, 'pedi_fec_pedi', $oIfx, '');
    $smotivo = consulta_string_func($sfecha, 'pedi_uso_pedi', $oIfx, '');
    $slugar = consulta_string_func($sfecha, 'pedi_lug_entr', $oIfx, '');
    ...
    if ($oIfx->Query($sql)) {
        if ($oIfx->NumFilas() > 0) {
            ...
            from saeccosn where ccosn_cod_ccosn= '$cos'";
                ...
                $oIfxB->Free();
                $des .= ' <tr >
                            <td style="font-size:80%;"align="center" width="4%"  border-top:"1px;">' . $i . '</td>
                            <td style="font-size:80%;"align="center" width="20%">' . $citem . '</td>
                            <td style="font-size:80%;"align="center" width="40%">' . $nom_prod . '</td>
                            <td style="font-size:80%;"align="center" width="10%"> ' . $sigla . '</td>
                            <td style="font-size:80%;"align="center" width="10%"> ' . $cantidad . '</td>
                            <td style="font-size:80%;"align="left" width="16%"> ' . $detaprod . '</td>';
                $des .= '</tr>';
                $i++;
                $cont++;
...
<table border="0" style="width: 80%; margin-left: 100px;">
    <tr>
        <td style="width: 90%; font-size:10px; text-align: left"><strong>Solicitante:</strong> $slugar </td>
    </tr>    
    <tr>
    ...
    <tr>
        <td style="width: 90%; font-size:10px; text-align: left"><strong>DESCRIPCIÓN: </strong> $obs_pedido </td>
    </tr>
    <tr>
...
<table  border="0"  cellpadding="0">
    <tr>
        ...
        <td style = "font-size:75%;" align="center" width="4%;" border="1px;"> <strong>N.-</strong></td>
        <td style = "font-size:75%;" align="center" width="20%;" border="1px;"> <strong>CODIGO</strong></td>
        <td style = "font-size:75%;" align="center" width="40%;" border="1px;"> <strong>PRODUCTO</strong></td>
        <td style = "font-size:75%;" align="center" width="10%;" border="1px;"> <strong>UNID.</strong></td>
        <td style = "font-size:75%;" align="center" width="10%;" border="1px;"> <strong>CANT.</strong></td>
        <td style = "font-size:75%;" align="center" width="16%;" border="1px;"> <strong>USO</strong></td> 
    </tr>
     $des
    <tr>
    ...
    <td style="font-size:80%;" align="center"  width="25%">
        <table cellspacing="8">
            ...
            <tr>
                <td align="center"><strong>Autorizado por:</strong></td>
            </tr>
            <tr>
                <td align="center"></td>
            </tr>
     ...
     <table cellspacing="8">
         ...
         <tr>
             <td align="center"><strong>Administrador General</strong></td>
         </tr>
         <tr>
            <td align="center"></td>
        </tr>         
