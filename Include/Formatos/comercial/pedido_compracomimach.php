...
<table  border="0"  cellpadding="0">
    ...
    <td style="font-size:80%;" align="center" width="20%">
        <table cellspacing="8">
            ...
            <tr>
                <td align="center">SHIGUE LUNA BYRON RAMIRO</td>
            </tr>
        </table>    
    </td>
    ...
    <td style="font-size:80%;" align="center"  width="20%">
        <table cellspacing="8">
            ...
            <tr>
                <td align="center"><strong>Jefe Zona Norte</strong></td>
            </tr>
            <tr>
                <td align="center">ING. MACHUCA VIVANCO CARLOS</td>
            </tr>
        </table>    
     </td>
     <td style="font-size:80%;" align="center"  width="20%">
     <table cellspacing="8">
         ...
         <tr>
            <td align="center">AB. MACHUCA QUIÑONEZ JACKSON</td>
        </tr>         
     </table>    
    </td>
    </tr>
