...
//echo $monto;exit;
  ...
  if(preg_match("/INTERNACIONAL/i",$formato)||preg_match("/GUAYAQUIL/i",$formato)||preg_match("/BOLIVARIANO/i",$formato)){
	...
	$log = strlen($beneficiario);
	  ...
	  for($log; $log<=100; $log++){
		...
		if($log == 100){
		 ...
		 $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 12px;">
					   <tr >
							<td style=" width: 80%; height: 24px; font-size:12px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width:20%; height: 24px; font-size:12px;" >**'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr style="m">
							<td style="width: 100%; height: 15px; font-size:12px;" colspan="2"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
						</tr>
						<tr   >
							<td colspan="2" style="width: 100%;height: 15px; font-size:14px; " > xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxx xxxxxxxxxxx</td>
						</tr>
						<tr>
					...
					$html.='<page backimgw="10%" backtop="10mm" backbottom="10mm" backleft="10mm" backright="4mm">';
					$html.=$tablePDF;
					$html.= '</page>';
	...
	if(preg_match("/PICHINCHA/i",$formato)){
	  ...
	  for($log; $log<=100; $log++){
		...
		if($log == 100){
		 ...
		 $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 5px;">
					   <tr >
							<td style=" width: 80%; height: 24px; font-size:12px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width:20%; height: 24px; font-size:12px;" >**'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						...
						<tr   >
							<td colspan="2" style="width: 100%;height: 20px; font-size:14px; " > xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxx xxxxxxxxxxx</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 8px; font-size:12px; " > '.$ciudad.','.$fecha.'</td>
						</tr>
					...
					$html.='<page backimgw="10%" backtop="14mm" backbottom="10mm" backleft="12mm" backright="4mm">';
					$html.=$tablePDF;
					$html.= '</page>';
	}
	if(preg_match("/PRODUBANCO/i",$formato)){
	  ...
	  for($log; $log<=100; $log++){
		...
		if($log == 100){
		 ...
		 $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 7px;">
					   <tr >
							<td style=" width: 80%; height: 24px; font-size:12px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width:20%; height: 24px; font-size:12px;" >**'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						...
						<tr   >
							<td colspan="2" style="width: 100%;height: 18px; font-size:14px; " > xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxx xxxxxxxxxxx</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 8px; font-size:12px; " > '.$ciudad.','.$fecha.'</td>
						</tr>
					...
					$html.='<page backimgw="10%" backtop="8mm" backbottom="10mm" backleft="11mm" backright="4mm">';
					$html.=$tablePDF;
					$html.= '</page>';
	}
