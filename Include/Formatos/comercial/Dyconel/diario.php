...
function formato_diario($idempresa = "", $idsucursal = "", $asto_cod = "", $ejer_cod = "", $prdo_cod = "")
{
    ...
    $html .= '
		...
		<table border="0" style="width:90%; margin-left:50px; ">
				<tr>
					...
					<td style="width: 50%; font-size:14px; text-align: left"><strong>Modulo:</strong>' . $modu_des_modu . '</td>
				</tr>
				
				<tr>
					<td  style="width:50%; font-size:14px; text-align: left"><strong>Monto: </strong>$ ' . number_format($asto_vat_asto, 2, '.', ',') . '</td>
					<td style="width: 50%; font-size:14px; text-align: left"><strong>Documento:</strong> ' . $asto_cod_tidu . ' - ' . $tidu_des_tidu . '</td>
				</tr>
				<tr>
					<td  style="width: 50%; font-size:14px; text-align: left"><strong>Beneficiario: </strong> ' . $asto_ben_asto . '</td>
					<td style="width: 50%; font-size:14px; text-align: left"><strong>Comprobante No:</strong>' . $asto_cod_asto . '</td>
				</tr>
			
				<tr>
					<td colspan="2" style="width: 50%; font-size:14px; text-align: left"><strong>Detalle:</strong> ' . $asto_det_asto . '</td>
    ...
    if (count($arrayDiario) > 0) {
        ...
        if ($oIfx->Query($sql)) {
            ...
            $html.= '<table style="width:80%; margin-top: 80px" align="center" >
					
            <tr>
                <td style="width:20%"></td>
                <td style="width:20%; font-size:13px; text-align: center;border-top : 2px solid black;">Ingresado por:<br>'.$usuario.'</td>
                <td style="width:20%;"></td>
                <td style="width:20%; font-size:13px; text-align: center;border-top : 2px solid black;">Recibí Conforme</td>
                <td style="width:20%;"></td>
            </tr>
