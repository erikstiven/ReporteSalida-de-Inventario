...
function formato_egreso($idempresa = "", $idsucursal = "", $asto_cod = "", $ejer_cod = "", $prdo_cod = "")
{
    ...
    $html .= '
        <table border = "0" style="width: 100%; margin-left: 50px; margin-top:20px">
            <tr>
                <td style="font-size:18px; text-align: left;">'.$empr_logo.'</td>
            </tr>
        </table>
        <table border="0" style="width: 100%;">
            ...
            <tr>
                <td style="width: 100%; font-size:14px; text-align: center"><strong>RUC: ' . $empr_ruc . '</strong></td>
            </tr>
            <tr>
                <td style="width: 100%; font-size:16px; text-align: center"><br><strong>Comprobante de Egreso</strong></td>
            </tr>
		</table>
        <table border="0" style="width:90%; margin-left: 50px; margin-top:10px" >
				<tr>
					<td style="width: 50%;font-size:14px; text-align: left"><strong>Fecha:</strong> ' . $ciudad . ', ' . $asto_fec . '</td>
					<td style="width: 50%; font-size:14px; text-align: left"><strong>EGRESO Nro:</strong> ' . $asto_cod_asto . '</td>
				</tr>
				<tr>
					<td style="width: 50%;font-size:14px; text-align: left"><strong>Pagado a:</strong> ' . $asto_ben_asto . '</td>
					<td style="width: 50%; font-size:14px; text-align: left"><strong>ASIENTO Nro:</strong> ' . $asto_cod_asto . '</td>
				</tr>
				<tr>
					<td  style="width:50%; font-size:14px; text-align: left"><strong>Banco:</strong> '.$banco.'</td>
					<td style="width: 50%; font-size:14px; text-align: left">&nbsp;</td>
				</tr>
				<tr>
					<td  style="width: 50%; font-size:14px; text-align: left"><strong>Cuenta Bancaria:</strong> '.$num_cta.'</td>
					<td style="width: 50%; font-size:14px; text-align: left"><strong>Cheque Nro:</strong> '.$numcheque.'</td>
				</tr>
			
				<tr>
					<td colspan="2" style=" width: 50%; font-size:14px; text-align: left"><strong>Por Concepto de: </strong> ' . $asto_det_asto . '</td>
					
				</tr>';

    if ($minv_prec_caja != '') {
        $html .= '<tr>
					<td  style="width: 50%; font-size:14px; text-align: left"><strong>Responsable Caja: </strong> ' . $array_empl[$minv_prec_caja] . '</td>
    ...
    if (count($arrayDiario) > 0) {
        ...
        $html .= '</tr>';
        $html .= '<tr>';
        $html .= '<td style="width:55%;font-size:14px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Cuenta Contable</strong></td>';
        ...
        foreach ($arrayDiario as $val) {
            ...
            $html .= '<tr>';
            $html .= '<td style="width:55%;font-size:14px; text-align: left;  border-bottom:1px; border-right:1px ">' . $dasi_cod_cuen . ' - ' . $cuen_nom_cuen . '</td>';
            ...
            $html .= '<td style="width:15%;font-size:14px; text-align: left;  border-bottom:1px; border-right:1px ">' . $dasi_num_depo . '</td>';
        ...
        $html .= '<table style="width:80%; margin-top: 60px" align="center" >
        <tr>

            <td style="width:30%; font-size:13px; text-align: center;border-top : 2px solid black;">Ingresado por:<br>' . $usuario . '</td>
            <td style="width:5%;"></td>
            <td style="width:30%;font-size:13px; text-align: center;border-top : 2px solid black;">Aprobado por:</td>
            <td style="width:5%;"></td>
            <td style="width:30%;font-size:13px; text-align: center;border-top : 2px solid black;">Recib&iacute; Conforme:<br>'.$asto_ben_asto.'</td>
