...
function formato_ingreso($idempresa = "", $idsucursal = "", $asto_cod = "", $ejer_cod = "", $prdo_cod = "")
{
    ...
    <td style="width: 75%;">
        <table border="0" style="width: 100%;" align="left">
            ...
            <tr>
            <td style="width: 100%; font-size:20px; text-align: center"><strong><br>COMPROBANTE DE INGRESO</strong><br><br></td>
        </tr>
        </table>
    </td>
    </tr> 
		...
		<table border="0" style="width:90%; margin-left:50px; ">
				<tr>
					...
					<td style="width: 50%; font-size:13px; text-align: left"><strong>Modulo:</strong>' . $modu_des_modu . '</td>
				</tr>
				
				<tr>
					<td  style="width:50%; font-size:13px; text-align: left"><strong>Monto: </strong>$ ' . number_format($asto_vat_asto, 2, '.', ',') . '</td>
					<td style="width: 50%; font-size:13px; text-align: left"><strong>Documento:</strong> ' . $asto_cod_tidu . ' - ' . $tidu_des_tidu . '</td>
				</tr>
				<tr>
					<td  style="width: 50%; font-size:13px; text-align: left"><strong>Beneficiario: </strong> ' . $asto_ben_asto . '</td>
					<td style="width: 50%; font-size:13px; text-align: left"><strong>Comprobante No:</strong>' . $asto_cod_asto . '</td>
				</tr>
			
				<tr>
					<td colspan="2" style="width: 50%; font-size:13px; text-align: left"><strong>Detalle:</strong> ' . $asto_det_asto . '</td>
    ...
    if (count($arrayDiario) > 0) {
       ...
       // $html .= '<td style="width:15%;font-size:14px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Centro Costos</strong></td>';
        ...
        <tr>
            <td style="width:21.25%; font-size:13px; text-align: center;border-top : 2px solid black;">Autorizado:</td>
            <td style="width:5%;"></td>
            <td style="width:21.25%;font-size:13px; text-align: center;border-top : 2px solid black;">Contador:</td>
            <td style="width:5%;"></td>
            <td style="width:21.25%;font-size:13px; text-align: center;border-top : 2px solid black;">Contabilidad:<br>'.$nombre_usuario.'</td>
        </tr>
            </table>';
    }
    return $html;
