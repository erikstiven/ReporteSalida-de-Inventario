...
function formato_diario($idempresa = "", $idsucursal = "", $asto_cod = "", $ejer_cod = "", $prdo_cod = "")
{
    ...
    $html .= '
		...
		<table border="0" style="width:90%; margin-left:50px; ">
				...
				<tr>
					<td  style="width:50%; font-size:12px; text-align: left"><strong>Monto: </strong>' . $moneda_principal . ' ' . number_format($asto_vat_asto, 2, '.', ',') . '</td>
    ...
    if (!empty($dchc_fec_dchc)) {
        $html .= '
        <tr>
            <td style="width: 50%; font-size:12px; text-align: left"><strong>Fecha Registro:</strong> ' . $asto_fec_serv . '</td>
            <td style="width: 50%; font-size:12px; text-align: left"><strong>Fecha Cheque:</strong> ' . $dchc_fec_dchc . '</td>
        </tr>               
        ';
    } else {
        $html .= '
    ...
    if (!empty($arrayDiario)) {
        if (count($arrayDiario) > 0) {
            ...
            $html .= '<tr>';
            $html .= '<td colspan="7" style="width:100%;font-size:14px; text-align: center; border-bottom:1px;"><strong>DIARIO</strong></td>';
            $html .= '</tr>';
            $html .= '<tr>';
            ...
            $html .= '<td style="width:12%;font-size:12px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Centro Costos</strong></td>';
            $html .= '<td style="width:12%;font-size:12px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Centro Actividad</strong></td>';
            $html .= '<td style="width:9%;font-size:12px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Documento</strong></td>';
            $html .= '<td style="width:18%;font-size:12px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Detalle</strong></td>';
            $html .= '<td style="width:12%;font-size:12px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Debito</strong></td>';
            $html .= '<td style="width:12%;font-size:12px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Credito</strong></td>';
            $html .= '</tr>';
            $totalDeb = 0;
            $totalCre = 0;
            foreach ($arrayDiario as $val) {
                ...
                $html .= '<td style="width:12%;font-size:10px; text-align: left;  border-bottom:1px; border-right:1px ">' . $ccos_cod_ccos . ' - ' . $ccosn_nom_ccosn . '</td>';
                $html .= '<td style="width:12%;font-size:10px; text-align: left;  border-bottom:1px; border-right:1px ">' . $dasi_cod_cact . ' - ' . $cact_nom_cact . '</td>';
                $html .= '<td style="width:9%;font-size:10px; text-align: left;  border-bottom:1px; border-right:1px ">' . $dasi_num_depo . '</td>';
                $html .= '<td style="width:18%;font-size:10px; text-align: left;  border-bottom:1px; border-right:1px ">' . $dasi_det_dasi . '</td>';
                $html .= '<td style="padding: 8px; width:12%;font-size:10px; text-align: right; border-bottom:1px; border-right:1px; margin-top:20px "><label >' . number_format($dasi_dml_dasi, 2, '.', ',') . '</label></td>';
                $html .= '<td style="padding: 8px; width:12%;font-size:10px; text-align: right; border-bottom:1px; border-right:1px ">' . number_format($dasi_cml_dasi, 2, '.', ',') . '</td>';
                $html .= '</tr>';
            ...
            $html .= '<tr>';
            $html .= '<td align="right" style="width:76%;font-size:12px; text-align: right;" colspan="5"><strong>TOTAL</strong></td>';
            $html .= '<td align="right" style="padding: 8px; width:12%;font-size:10px; text-align: right;">' . number_format($totalDeb, 2, '.', ',') . '</td>';
            $html .= '<td align="right" style="padding: 8px; width:12%;font-size:10px;">' . number_format($totalCre, 2, '.', ',') . '</td>';
            $html .= '</tr>';
            $html .= '</table>';
            $sql = "select minv_num_comp, minv_num_caja, minv_prec_caja from saeminv where minv_cod_empr='$idempresa' and minv_cod_sucu='$idsucursal' and 
				minv_cod_ejer='$ejer_cod' and minv_num_prdo='$prdo_cod' and minv_tran_minv='$asto_cod'";
