...
//echo $monto;exit;
  ...
  ////
   if(preg_match("/GUAYAQUIL/i",$formato)||preg_match("/PACIFICO/i",$formato)||preg_match("/BOLIVARIANO/i",$formato)){
   ...
   if(trim($formato)=='CHEQUE_PICHINCHA'){
	...
	$beneficiario=substr($beneficiario,0,48);
		 $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-left:50px; margin-top: 35px;">
					   <tr >
							<td style=" width: 63%; height: 19px; font-size:11px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width: 37%; height: 19px; font-size:13px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr style="m">
							<td style="width: 100%; height: 6px; font-size:11px;" colspan="2" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 15px; font-size:12px; " >&nbsp;xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxxx</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 8px; font-size:11px; "  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ciudad.','.$fecha.'</td>
						</tr>
					</table>';
	$html.='<page backimgw="10%" backtop="50mm" backbottom="10mm" backleft="100mm" backright="4mm">';
	$html.=$tablePDF;
	$html.= '</page>';	
	$html2pdf = new HTML2PDF('L', 'C5', 'es');
	...
	if(trim($formato)=='CHEQUE_PICHINCHA_EPSON'){
	...
	$beneficiario=substr(trim($beneficiario),0,48);
		 $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-left:50px; margin-top: 39px;">
					   <tr >
							<td style=" width: 75%; height: 19px; font-size:9px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width: 25%; height: 19px; font-size:12px;" >&nbsp;'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr style="m">
							<td style="width: 100%; height: 6px; font-size:10px;" colspan="2" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 15px; font-size:12px; " >&nbsp;xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxxx</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 8px; font-size:10px; "  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ciudad.','.$fecha.'</td>
						</tr>
					</table>';
	$html.='<page backimgw="10%" backtop="50mm" backbottom="10mm" backleft="100mm" backright="4mm">';
	$html.=$tablePDF;
  ...
  for($log; $log<=100; $log++){
	...
	$beneficiario=substr($beneficiario,0,40);
	 $tablePDF='<table border="0" style="font-family:dejavusans; width: 80%; margin: 0px;  margin-left:20px; margin-top: 30px;" align="left">
				   <tr >
						<td style=" width: 49%; height: 24px; font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
						<td style=" width: 51%; height: 24px; font-size:12px;" >'.number_format($monto, 2, '.', '').'</td>
					</tr>
					<tr >
						<td style="width: 100%; height: 14px; font-size:13px;" colspan="2" >&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
					</tr>
					<tr>
						<td colspan="2" style="width: 100%;height: 20px; font-size:13px; " >xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxxx</td>
					</tr>
					<tr>
						<td colspan="2" style="width: 100%;height: 8px; font-size:13px; "  >'.$ciudad.','.$fecha.'</td>
					</tr>
				</table>';
$html.='<page  backtop="0mm" backbottom="2mm" backleft="0mm" backright="0mm">';
$html.=$tablePDF;
$html.= '</page>';
$html2pdf = new HTML2PDF('L', array(230, 297), 'es');
...
//Configuracion Impresora TamaÃƒÂ±o: A4 Ajusta el area de impresiÃƒÂ³n
