...
function reporte_factura_personalizado($id = '', $nombre_archivo = '', $idSucursal ='', &$rutaPdf = '') {
  ...
  $arrayTipDoc = array_dato($oCon, $sql, 'clpv_cod_clpv', 'clv_con_clpv');
    ...
    if ($oIfx->Query($sqlFac)) {
        if ($oIfx->NumFilas() > 0) {
            do {
                ...
                $logo .= '<tr>';
                $logo .= '<td align="center"><img width="100px;"  src="' . $path_logo_img . '"></td>';
    ...
    $totales .= ' <tr>';
    $totales .= ' <b> <td width="185" height="18" align="right">Total Op. Gravadas S/</td> </b>';
    ...
    $totales .= ' <tr>';
    $totales .= ' <b> <td width="185" height="18" align="right">Total Op. Inafectas S/</td> </b>';
    $totales .= ' <td width="110" align="right">' . number_format( $tot_opinafe, 2, '.', ',') . '</td>';
    $totales .= ' </tr>';


    $totales .= ' <tr>';
    $totales .= ' <b> <td width="185" height="18" align="right">Total Op. Exoneradas S/</td> </b>';
    ...
    $totales .= ' <tr>';
    $totales .= ' <b> <td width="185" height="18" align="right">Total Descuentos S/</td> </b>';
    $totales .= ' <td width="110" align="right">' . number_format($fact_dsg_valo, 2, '.', ',') . '</td>';
    $totales .= ' </tr>';

    $totales .= ' <tr>';
    $totales .= ' <b> <td width="185" height="18" align="right">Total ISC S/</td> </b>';
    $totales .= ' <td width="110" align="right">0.00</td>';
    $totales .= ' </tr>';


    $totales .= ' <tr>';
    $totales .= ' <b> <td width="185" height="18" align="right">Importe Total S/</td> </b>';
