...
//FECHA DE DEL PEDIDO
    ...
    $smotivo = strtoupper(consulta_string_func($sfecha, 'pedi_det_pedi', $oIfx, ''));
...
<table  border="0"  cellpadding="0">
    ...
    <td style="font-size:80%;" align="center" width="20%">
        <table cellspacing="8">
            ...
            <tr>
            <td align="center"><strong>Bodeguero</strong></td>
            </tr>
            <tr>
                <td align="center"> SEGUNDO MOISES RAMOS JIMENEZ</td>
            </tr>
        </table>    
    </td>
    <td style="font-size:80%;" align="center" width="20%">
    ...
    <td style="font-size:80%;" align="center" width="20%">
        <table cellspacing="8">
            ...
            <tr>
                <td align="center">JOEL VARGAS RAMIREZ</td>
            </tr>
        </table>    
    </td>
    ...
    <td style="font-size:80%;" align="center"  width="20%">
     ...
     <table cellspacing="8">
         ...
         <tr>
             <td align="center"><strong>Gerente Producción</strong></td>
         </tr>
         <tr>
            <td align="center">CARLOS MACHUCA VIVANCO</td>
        </tr>         
     </table>    
    </td>
    </tr>
