...
//echo $monto;exit;
  ...
  ////
   if(preg_match("/PRODUBANCO/i",$formato)||preg_match("/PACIFICO/i",$formato)||preg_match("/MACHALA/i",$formato)){
	   //BOLIVARIANO
	$log = strlen($beneficiario);
	  ...
	  for($log; $log<=100; $log++){
		...
		if($log == 100){
		 ...
		 $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 40px;">
					   <tr >
							<td style=" width: 63%; height: 20px; font-size:12px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width:37%; height: 20px; font-size:14px;" >'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr style="m">
							<td style="width: 100%; height: 16px; font-size:14px;" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 16px; font-size:14px; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxx</td><br>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 12px; font-size:14px; " >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ciudad.','.$fecha.'</td>
						</tr>
					</table>';		
	 /*  $tablePDF='<table   align="left" style="margin-left: 0px; ">
				<tr style="font-size:15px; ">
					<td height="200" valign="bottom">
						<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$linea.'<br><br>
						   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'xxxxxxxxx<br><br>
 ...
 $log = strlen($beneficiario);
   ...
   for($log; $log<=100; $log++){
	 ...
	 if($log == 100){
	  ...
	  $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 50px;">
					<tr >
						 <td style=" width: 63%; height: 20px; font-size:12px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
						 <td style=" width:37%; height: 20px; font-size:14px;" >'.number_format($monto, 2, '.', ',').'</td>
					 </tr>
 ...
 $log = strlen($beneficiario);
   ...
   for($log; $log<=100; $log++){
	 ...
	 if($log == 100){
	  ...
	  $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 65px;">
					<tr >
						 <td style=" width: 63%; height: 20px; font-size:12px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
						 <td style=" width:37%; height: 20px; font-size:14px;" >'.number_format($monto, 2, '.', ',').'</td>
					 </tr>
 ...
 $log = strlen($beneficiario);
   ...
   for($log; $log<=100; $log++){
	 ...
	 if($log == 100){
	  ...
	  $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 55px;">
					<tr >
						 <td style=" width: 63%; height: 20px; font-size:11px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
						 <td style=" width:37%; height: 20px; font-size:14px;" >'.number_format($monto, 2, '.', ',').'</td>
					 </tr>
					 <tr style="m">
						 <td style="width: 100%; height: 16px; font-size:14px;" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
   ...
   if(preg_match("/SEG/i",$formato)){
		...
		$spa = '';
		  ...
		  //$linea = $beneficiario.$spa.$monto;   font-weight: bold;
	    $tablePDF='<table   align="left" style="margin-left: 47px; font-family: Arial;">
					<tr style="font-size:13px;"> 
						<!-- <td height="98" valign="bottom">  -->
						<td style=" width: 63%; height: 80px;">
							<p> <br><br> </p>
							<p>'.$linea.'<br><br>
							   '.$letra.'<br>
							xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx xxxxxx<br><br>
