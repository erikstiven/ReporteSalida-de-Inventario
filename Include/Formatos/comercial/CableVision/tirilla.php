...
function formato_tirilla($id,$tipo){
    ...
    if ($contador > 0) {
        ...
        $deta .= '<td style="width: 128; font-size: 7px;font-family: Arial;" align="center">Descripción</td>';
       // $deta .= '<td style="width: 45; font-size: 7px;font-family: Arial;" align="center">DETALLE</td>';
        $deta .= '<td style="width: 30; font-size: 7px;fosnt-family: Arial;" align="center">Precio</td>';
    //$deta .= '<td style="width: 22; font-size: 7px;font-family: Arial;" align="center">Dsc.</td>';
        $deta .= '<td style="width: 30; font-size: 7px;font-family: Arial;" align="center">Importe</td>';
        $deta .= '</tr>
                    <tr>
                        <td colspan="4" style="border-top: 1px solid dashed;" width="200"></td>
                    </tr>';
        ...
        if ($oIfx->Query($sqlDeta)) {
            if ($oIfx->NumFilas() > 0) {
                ...
                elseif($dfac_obj_iva ==1 && $dfac_exc_iva!=1){
                    ...
                    $deta .= ' <td style="width: 128;font-family: Arial; font-size: 7px;">' . $dfac_nom_prod . '</td>';
                    //$deta .= ' <td style="width: 45;font-family: Arial; font-size: 5px;">' . $dfac_det_dfac . '</td>';
                    $deta .= ' <td style="width: 30; font-family: Arial; font-size: 7px;" align="right">' . number_format($dfac_precio_dfac, 2, '.', ',') . '</td>';
                   // $deta .= ' <td style="width: 22; font-family: Arial; font-size: 7px;" align="right">' . number_format($dfac_des1_dfac, 1, '.', ',') . '</td>';
                    $deta .= ' <td style="width: 30; font-family: Arial; font-size: 7px;" align="right">' . number_format($dfac_mont_total, 2, '.', ',') . '</td>';
                    $deta .= ' </tr>';
    ...
    if($fact_cod_mone==$pcon_seg_mone)
    {
     ...
     $ruta=DIR_FACTELEC . 'modulos/envio_documentos/qr_facturas/FAC_'.$id.'.png';
        ...
        $totales .= ' <tr>';
        $totales .= ' <td style="width: 178;font-size: 7px;font-family: Arial;" align="right" colspan="3">Gravada: '.$eti_mone.'</td>';
        $totales .= ' <td style="width: 22;font-size: 7px;font-family: Arial;" align="right">' . number_format($tot_opgrav, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <td style="width: 178;font-size: 7px;font-family: Arial;" align="right" colspan="3">Exonerado: '.$eti_mone.'</td>';
        $totales .= ' <td style="width:22;font-size: 7px;font-family: Arial;" align="right">' . number_format($tot_opexo, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <td style="width: 178;font-size: 7px;font-family: Arial;" align="right" colspan="3">Gratuito: '.$eti_mone.'</td>';
        $totales .= ' <td style="width: 22;font-size: 7px;font-family: Arial;" align="right">' . number_format($tot_opinafe, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <td style="width: 178;font-size: 7px;font-family: Arial;" align="right" colspan="3">' . $array_imp ['IVA'] . '  ('.number_format($porcentaje,2).'%): '.$eti_mone.'</td>';
        $totales .= ' <td style="width: 22;font-size: 7px;font-family: Arial;" align="right">' . number_format($fact_iva, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <td style="width: 178;font-size: 7px;font-family: Arial;" align="right" colspan="3">Descuento Total: '.$eti_mone.'</td>';
        $totales .= ' <td style="width: 22;font-size: 7px;font-family: Arial;" align="right">' . number_format($fact_dsg_valo, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .= ' <tr>';
        $totales .= ' <td style="width: 178;font-size: 7px;font-family: Arial;" align="right" colspan="3">Total: '.$eti_mone.'</td>';
        $totales .= ' <td style="width: 22;font-size: 7px;font-family: Arial;" align="right">' . number_format($fact_tot_fact, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';

        $totales .='<tr>';
        $totales .='<td colspan="4" style="border-top: 1px solid dashed;" width="200"></td>';
        $totales .='</tr>';
        ...
        $html .=    '<table style="width: 100%;">
                        ...
                        <tr>
                        <td style="font-size: 7px;font-family: Arial;" width="200" align="center">Representación Impresa de la '.$titulo.'
                        </td>
                        </tr>   
                        <tr>
        ...
        $html .=    '    <tr>
                        ...
                        <tr>
                        <td style="font-size: 8px;font-family: Arial;" width="200" align="center"><i>Gracias por preferirnos </i>  </td>
                        </tr>
