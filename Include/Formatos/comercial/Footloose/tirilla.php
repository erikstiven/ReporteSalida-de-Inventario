...
function formato_tirilla($id,$tipo){
    ...
    if (file_exists($path_logo_img)) {
        $logo_empresa=' <img width="170px;"  src="' . $path_logo_img . '"'.$style_image.'>';
    }
    else{
    ...
    if ($contador > 0) {
        ...
        $deta .= ' <b> <td style="width: 40; font-size: 7px;font-family: Arial;" align="center">SKU</td> </b>';
        $deta .= ' <b> <td style="width: 41; font-size: 7px;font-family: Arial;" align="center">COD. UNICO</td> </b>';
        ...
        if ($oIfx->Query($sqlDeta)) {
            if ($oIfx->NumFilas() > 0) {
                ...
                if ($dfac_por_dsg > 0) {
                    ...
                    $deta .= ' <td style="width: 40;font-family: Arial; font-size: 7px;">' . $dfac_cod_prod . '</td>';
        ...
        if($fact_cod_mone==$pcon_seg_mone)
    {
        ...
        $totales .= ' <td style="width: 50;font-size: 7px;font-family: Arial;" align="right">' . number_format($fact_con_miva+$fact_sin_miva+$fact_dsg_valo, 2, '.', ',') . '</td>';
        $totales .= ' </tr>';
    ...
    $ruta=DIR_FACTELEC . 'modulos/facturacion_boostrap/qr_facturas/REC_'.$id.'.png';
        ...
        $html .=    '
                        ...
                        <tr>
                            ...
                            <br>Este documento puede ser validado en: <br>www.footloose.pe</td>
                        </tr>
                        </table>
