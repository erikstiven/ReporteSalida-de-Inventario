...
function formato_egreso($idempresa = "", $idsucursal = "", $asto_cod = "", $ejer_cod = "", $prdo_cod = "")
{
    ...
    $html .= '
    <table  border="0" style="width: 100%;margin-top:0px"  align="center">
    <tr>
    ...
    <td style="width: 75%;">
        <table border="0" style="width: 100%;" align="left">
            ...
            <tr>
                <td style="width: 100%; font-size:18px; text-align: center"><strong><br>Comprobante de Egreso</strong><br><br></td>
            </tr>
        </table>
    </td>
    </tr> 
    ...
    <table border="0" style="width:100%; margin-left:50px;">
				...
				<tr>
					<td style="width: 50%;font-size:12px; text-align: left"><strong>Pagado a:</strong> ' . $asto_ben_asto . '</td>
					<td style="width: 50%; font-size:12px; text-align: left"><strong>ASIENTO Nro:</strong> ' . $asto_cod_asto . '</td>
				</tr>
				<tr>
					<td  style="width:50%; font-size:12px; text-align: left"><strong>Banco:</strong> '.$banco.'</td>
					<td style="width: 50%; font-size:12px; text-align: left">&nbsp;</td>
				</tr>
				<tr>
					<td  style="width: 50%; font-size:12px; text-align: left"><strong>Cuenta Bancaria:</strong> '.$num_cta.'</td>
					<td style="width: 50%; font-size:12px; text-align: left"><strong>Cheque Nro:</strong> '.$numcheque.'</td>
				</tr>
			
				<tr>
					<td colspan="2" style=" width: 50%; font-size:12px; text-align: left"><strong>Por Concepto de: </strong> ' . $asto_det_asto . '</td>
    ...
    if ($minv_prec_caja != '') {
        $html .= '<tr>
					...
					<td style="width: 50%;font-size:12px; text-align: left"><strong>Secuencia No:</strong>' . $minv_num_caja . '</td>
    ...
    if (count($arrayDirectorio) > 0) {
        $html .= '
								<table  style="margin-left:50px; width:90%;border:1px solid black; border-radius: 5px; margin-top:2px" align="left">
									<tr>
    ...
    if (count($arrayRetencion) > 0) {
        ...
        $html .= '<table  style="margin-left:50px; width:90%;border:1px solid black; border-radius: 5px; margin-top:8px" align="left">';
        $html .= '<tr>';
    ...
    if (count($arrayDiario) > 0) {
        ...
        $html .= '<table style="margin-left:50px; width:90%; border:1px ; border-radius: 2px; margin-top:8px" align="left">';
        $html .= '<tr>';
        $html .= '<td colspan="6" style="width:100%;font-size:16px; text-align: center; border-bottom:1px;"><strong>DIARIO</strong></td>';
        $html .= '</tr>';
        $html .= '<tr>';
        ...
        foreach ($arrayDiario as $val) {
            ...
            $html .= '<td style="padding: 8px; width:15%;font-size:12px; text-align: right; border-bottom:1px; border-right:1px; margin-top:20px "><label>' . number_format($dasi_dml_dasi, 2, '.', ',') . '</label></td>';
        ...
        $html .= '<td align="right" style="padding: 8px; width:8%;font-size:12px; text-align: right;">' . number_format($totalDeb, 2, '.', ',') . '</td>';
        $html .= '<td align="right" style="padding: 8px; width:8%;font-size:12px;">' . number_format($totalCre, 2, '.', ',') . '</td>';
        $html .= '</tr>';
        $html .= '</table>';
                ...
                do {
                    ...
                    if ($oIfx2->Query($sql2)) {
                        if ($oIfx2->NumFilas() > 0) {
                            ...
                            do {
                                $html .= '<tr>';
                                $html .= '<td  style="width:3%;font-size:12px; text-align: center; border-right:1px solid; border-bottom:1px solid;">' . $i . '</td>
									<td  style="width:10%;font-size:12px; text-align: center; border-right:1px solid; border-bottom:1px solid;">' . $oIfx2->f('minr_fec_emis') . '</td>
									<td  style="width:15%;font-size:12px; text-align: center; border-right:1px solid; border-bottom:1px solid;">' . $oIfx2->f('minr_ide_prov') . '</td>
									<td  style="width:20%;font-size:12px; text-align: center; border-right:1px solid; border-bottom:1px solid;">' . $oIfx2->f('minr_num_esta') . '</td>
									<td  style="width:20%;font-size:12px; text-align: center; border-right:1px solid; border-bottom:1px solid;">' . $oIfx2->f('minr_pto_emis') . '</td>
									<td  style="width:20%;font-size:12px; text-align: center; border-right:1px solid; border-bottom:1px solid;">' . $oIfx2->f('minr_sec_docu') . '</td>
									<td  style="width:10%;font-size:12px; text-align: right;  border-right:1px solid; border-bottom:1px solid;">' . ($oIfx2->f('minr_con_miva') + $oIfx2->f('minr_sin_miva') + $oIfx2->f('minr_iva_valo')) . '</td>';
                                $html .= '</tr>';
                                $i++;
        ...
        <tr>
            ...
            <td style="width:21.25%; font-size:12px; text-align: center;border-top : 2px solid black;">Preparado por:<br>' . $nombre_usuario . '</td>
            <td style="width:5%;"></td>
            <td style="width:21.25%; font-size:12px; text-align: center;border-top : 2px solid black;">Revisado por:</td>
            <td style="width:5%;"></td>
            <td style="width:21.25%;font-size:12px; text-align: center;border-top : 2px solid black;">Aprobado por:</td>
            <td style="width:5%;"></td>
            <td style="width:21.25%;font-size:12px; text-align: center;border-top : 2px solid black;">Recib&iacute; Conforme:<br>'.$asto_ben_asto.'</td>
    ...
    $html1='';
    $html1.=$html;
    $html1.='<table style="width:100%; margin-top: 40px" align="center" ><tr> <td style="width:100%; font-size:12px; text-align: center;border-top : 0.5px solid black;"></td></tr></table>';  
    $html1.=$html;

    $page.='<page backimgw="10%" backtop="5mm" backbottom="10mm" backleft="10mm" backright="4mm">';
    $page.=$html1;
    $page.='</page>';
