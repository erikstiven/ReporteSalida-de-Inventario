...
//echo $monto;exit;
  ...
  ////
   ...
   if(preg_match("/PRODUBANCO/i",$formato)||preg_match("/GUAYAQUIL/i",$formato)||preg_match("/PACIFICO/i",$formato)||preg_match("/BOLIVARIANO/i",$formato)){
	...
	$beneficiario=substr($beneficiario,0,50);
		 $tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 34px;">
					   <tr >
							<td style=" width: 60%; height: 19px; font-size:11px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width: 40%; height: 19px; font-size:11px;" >**'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr style="m">
...
$beneficiario=substr($beneficiario,0,50);
   ...
   if(preg_match("/PROCREDIT/i",$formato)){
	...
	$html.='<page backimgw="10%" backtop="5mm" backbottom="10mm" backleft="11mm" backright="4mm">';
	$html.=$tablePDF;
	$html.= '</page>';
