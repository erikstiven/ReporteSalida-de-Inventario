...
if(preg_match("/PRODUBANCO/i",$formato)||preg_match("/PICHINCHA/i",$formato)){
	...
	$beneficiario=substr($beneficiario,0,60);

		

$tablePDF='<table border="0" style="width: 100%; margin: 0px;  margin-top: 55px; font-weight: 700;">
					   <tr >
							<td style=" width: 75%; height: 25px; font-size:13px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$beneficiario.'</td>
							<td style=" width:25%; height: 25px; font-size:14px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**'.number_format($monto, 2, '.', ',').'</td>
						</tr>
						<tr style="m">
							<td style="width: 100%; height: 14px; font-size:14px;" colspan="2"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$letra.'</td>
						</tr>
						<tr   >
							<td colspan="2" style="width: 100%;height: 16px; font-size:16px; " >xxxxxxxxxxxxxxxxxxx xxxxx xxxxxxxxx xxxxxxxxxxx </td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;height: 7px; font-size:16px; " >&nbsp;&nbsp;'.$ciudad.','.$fecha.'</td>
						</tr>
					</table>';		
		$html=$tablePDF;
...
//Configuracion Impresora Tamaño: A4 predeterminada
