...
//INFORMACION DE LA EMPRESA
 ...
 $sql = "select empr_cod_pais,empr_cm1_empr, empr_rimp_sn, empr_nom_empr, empr_ruc_empr , empr_dir_empr, empr_conta_sn, empr_num_resu, empr_path_logo, empr_iva_empr,empr_tel_resp, empr_ac1_empr, empr_ac2_empr, empr_mai_empr, empr_tip_empr
    ...
    $logo .= '<td width="320">'.$razonSocial.'</td>';
    $logo .= '<td width="80"><b>TELEFONO:</b></td>';
    $logo .= '<td  width="190">'.$tel_empresa.'</td>';
    $logo .= '</tr>';
    $logo .= '<tr style="font-size:12px;">';
    $logo .= '<td  width="100"><b>DIRECCION:</b></td>';
    $logo .= '<td  width="320">'.$dirMatriz.'</td>';
    $logo .= '<td  width="80"><b>EMAIL:</b></td>';
    $logo .= '<td  width="190">'.$empr_mai_empr.'</td>';
    $logo .= '</tr>';
    $logo .= '<tr style="font-size:12px;">';
    $logo .= '<td  width="100"><b>RUC:</b></td>';
    $logo .= '<td  width="320">'.$ruc_empr.'</td>';
    $logo .= '<td  width="80"></td>';
    $logo .= '<td  width="190"></td>';
    $logo .= '</tr>';
    $logo .='</table>';
    ...
    $logo .= '<td width="320">'.$nom_clpv.'</td>';
    $logo .= '<td width="80"><b>EMAIL:</b></td>';
    $logo .= '<td  width="190">'.$correo_clpv.'</td>';
    $logo .= '</tr>';
    $logo .= '<tr style="font-size:12px;">';
    $logo .= '<td  width="100"><b>DIRECCION:</b></td>';
    $logo .= '<td  width="320">'.$dire_clpv.'</td>';
    $logo .= '<td  width="80"><b>CONTACTO:</b></td>';
    $logo .= '<td  width="190"></td>';
    $logo .= '</tr>';
    $logo .= '<tr style="font-size:12px;">';
    $logo .= '<td  width="100"><b>RUC:</b></td>';
    $logo .= '<td  width="320">'.$ruc_clpv.'</td>';
    $logo .= '<td  width="80"><b>GARANTIA</b></td>';
    $logo .= '<td  width="190"></td>';
    $logo .= '</tr>';
    $logo .= '<tr style="font-size:12px;">';
    $logo .= '<td  width="100"></td>';
    $logo .= '<td  width="320"></td>';
    $logo .= '<td  width="80"><b>TELEFONO:</b></td>';
    $logo .= '<td  width="190">'.$tel_clpv.'</td>';
    $logo .= '</tr>';
    $logo .='</table>';
    ...
    $logo .= '<td width="320">'.$concepto.'</td>';
    $logo .= '<td width="80"><b>MONEDA:</b></td>';
    $logo .= '<td  width="190">'.$moneda.'</td>';
    $logo .= '</tr>';
    $logo .= '<tr style="font-size:12px;">';
    $logo .= '<td  width="100"><b>FORMA DE PAGO:</b></td>';
    $logo .= '<td  width="320">'.$fpago_prov.'</td>';
    $logo .= '<td  width="80"><b>BANCO:</b></td>';
    $logo .= '<td  width="190">'.$nom_banco.'</td>';
    $logo .= '</tr>';
    $logo .= '<tr style="font-size:12px;">';
    $logo .= '<td  width="100"><b>FACTURA:</b></td>';
    $logo .= '<td  width="320">'.$factura.'</td>';
    $logo .= '<td  width="80"><b>N° CUENTA:</b></td>';
    $logo .= '<td  width="190">'.$num_cta.'</td>';
    $logo .= '</tr>';
    $logo .= '<tr style="font-size:12px;">';
    $logo .= '<td  width="100"></td>';
    $logo .= '<td  width="320"></td>';
    $logo .= '<td  width="80"><b>CCI:</b></td>';
    $logo .= '<td  width="190">'.$cash_cod_int.'</td>';
    $logo .= '</tr>';
    $logo .='</table>';
    ...
    $firmas = '<table style="width:100%; margin-top: 65px" align="center" >
        <tr>
            ...
            <td style="width:5%;"></td>
            <td style="width:21.25%;font-size:10px; text-align: center;border-top : 2px solid black;"><b>GERENTE GENERAL<br>'.$razonSocial.'</b></td>
            <td style="width:5%;"></td>
