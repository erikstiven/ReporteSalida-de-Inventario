...
function formato_egreso($idempresa = "", $idsucursal = "", $asto_cod = "", $ejer_cod = "", $prdo_cod = "")
{
    ...
    $arrayDiario = $class->diarioAsientoContableAux($oIfx, $idempresa, $idsucursal, $ejer_cod, $prdo_cod, $asto_cod);
    ...
    $html .= '
        ...
        <table border="0" style="width: 68%; margin-left:50px;">
            <tr>
                <td style="width:50%; font-size:24px; text-align: left"></td>
            </tr>
            <tr>
                <td style="width:50%; font-size:24px; text-align: left"></td>
            </tr>
            <tr>
                <td style="width:50%; font-size:24px; text-align: left"><strong>' . $empr_nom . '</strong></td>
                <td style="width:50%; font-size:24px; text-align: left">Comprobante de Egreso</td>    
            </tr>
     <!--   
            <tr> 
                <td  style="width: 100%; font-size:14px; text-align: left"><strong>SUCURSAL: ' . $sucu_nom . '</strong></td>
            </tr> 
    -->
            <tr>
                <td  style="width: 40%; font-size:16px; text-align: left">DIRECCION: ' . $empr_dir . '</td>
                <td style="width: 30%; font-size:24px; text-align: left"><strong>&nbsp;&nbsp;&nbsp;E-' . $asto_cod_asto . '</strong></td>
            </tr>
    <!--           
            <tr>
                <td style="width: 100%; font-size:14px; text-align: left"><strong>RUC: ' . $empr_ruc . '</strong><br><br></td>
            </tr>
    -->        
            <tr>
                <td style="width: 100%; font-size:18px; text-align: center"></td>
            </tr>
		</table>
		<table border="0" style="width:65%; margin-left:50px; ">
				<tr>
					<td style="width: 50%;font-size:16px; text-align: left"><strong>Fecha:</strong> ' . $ciudad . ', ' . $asto_fec . '</td>
					<!-- <td style="width: 50%; font-size:12px; text-align: left"><strong>EGRESO Nro:</strong> ' . $asto_cod_asto . '</td> -->
				</tr>
				<tr>
					<td style="width: 40%;font-size:16px; text-align: left"><strong>Pagado a:</strong> ' . $asto_ben_asto . '</td>
                    <td  style="width:30%; font-size:16px; text-align: left"></td>
                    <td style="width: 30%;font-size:22px; text-align: center;">&nbsp;&nbsp;&nbsp;$:&nbsp;<strong>' . number_format($totalDeb, 2, '.', ',') . '</strong></td>
				</tr>
				<tr>
					<td  style="width:80%; font-size:16px; text-align: left"><strong>Banco:</strong> ' . $banco . '</td>
					<!--<td style="width: 20%; font-size:12px; text-align: left"><strong>Diario Nro:</strong> ' . $asto_cod_asto . '</td>-->
					<!--<td style="width: 50%; font-size:12px; text-align: left">&nbsp;</td> -->
				</tr>
				<tr>
					<td style="width: 30%; font-size:16px; text-align: left"><strong>Cuenta Bancaria:</strong> ' . $num_cta . '</td>
                    <td style="width: 30%; font-size:16px; text-align: left"><strong>Cheque Nro:</strong> ' . $numcheque . '</td>
                    <td style="width: 30%; font-size:16px; text-align: center"><strong>Diario Nro:</strong> ' . $asto_cod_asto . '</td> 
				</tr>
			
				<tr>
					<td colspan="2" style=" width: 50%; font-size:16px; text-align: left"><strong>Por Concepto de: </strong> ' . $asto_det_asto . '</td>
					<!-- <td style="width: 50%; font-size:16px; text-align: left"><strong>Cheque Nro:</strong> ' . $numcheque . '</td> -->
				</tr>';
    ...
    if (count($arrayDirectorio) > 0) {
        /*$html .= '
								<table  style="margin-left:50px; width:90%;border:0px solid black; border-radius: 5px; margin-top:20px" align="left">
									<tr>
									    <td colspan="6" style="width:100%; font-size:16px; text-align: center; border-bottom:0px solid "><strong>DIRECTORIO</strong></td>
									</tr>
									<tr>
										<td  style="width:3%;font-size:14px; text-align: center; border-right:0px solid; "><strong>N</strong></td>
										<td  style="width:30%;font-size:14px; text-align: center; border-right:0px solid; "><strong>CLIENTE / PROVEEDOR</strong></td>
										<td  style="width:10%;font-size:14px; text-align: center; border-right:0px solid; "><strong>TRANSACCION</strong></td>
										<td  style="width:20%;font-size:14px; text-align: center; border-right:0px solid; "><strong>FACTURA</strong></td>
										<td  style="width:10%;font-size:14px; text-align: center;  border-right:0px solid; "><strong>DEBITO</strong></td>
    ...
    */
    ...
    if (count($arrayDiario) > 0) {
        ...
        $html .= '<tr>';
        $html .= '<td colspan="5" style="width:100%;font-size:14px; text-align: center; border-bottom:1px;"><strong>DIARIO</strong></td>';
        $html .= '</tr>';
        $html .= '<tr>';
        $html .= '<td style="width:15%;font-size:18px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Codigo</strong></td>';
        $html .= '<td style="width:45%;font-size:18px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Descripcion</strong></td>';
        $html .= '<td style="width:20%;font-size:18px; text-align: center;  border-bottom:1px; border-right:1px ">Num Factura<strong></strong></td>';
        $html .= '<td style="width:10%;font-size:18px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Debito</strong></td>';
        $html .= '<td style="width:10%;font-size:18px; text-align: center;  border-bottom:1px; border-right:1px "><strong>Credito</strong></td>';
        $html .= '</tr>';
        $totalDeb = 0;
        $totalCre = 0;
        $primer_reg = 0;
        ...
        foreach ($arrayDiario as $val) {
            ...
            //Agregar Numero de Factura al Diario. B@nch
            
            if ($dasi_dml_dasi > 0 && $bandera === 0)
            {
                $primer_reg = $dasi_cod_dasi - 1;
                $bandera = 1;
                //echo $primer_reg; exit;
            }
            if ($dasi_cod_dir > 0)
            {
                //echo $dasi_cod_dir; exit;
                $contador_indicador=$dasi_cod_dir;
            }
            else
            {
                $contador_indicador=$dasi_cod_dasi - $primer_reg;
            }
            
            $dir_num_fact='';
            $sql = "select dir_num_fact from saedir where dire_cod_asto = '$asto_cod_asto' and dire_cod_empr =$idempresa and dire_cod_sucu =$idsucursal and asto_cod_ejer=$ejer_cod and asto_num_prdo=$prdo_cod and dir_cod_dir=$contador_indicador";
            //dir_deb_ml=$dasi_dml_dasi and
            ...
            $html .= '<tr>';
            $html .= '<td style="width:15%;font-size:16px; text-align: center;">' . $dasi_cod_cuen . '</td>';
            $html .= '<td style="width:45%;font-size:16px; text-align: left; ">' . $cuen_nom_cuen . '</td>';
            $html .= '<td style="width:20%;font-size:16px; text-align: center;">' . $dir_num_fact . '</td>';
            $html .= '<td style="padding: 8px; width:10%;font-size:16px; text-align: right; margin-top:20px "><label>' . number_format($dasi_dml_dasi, 2, '.', ',') . '</label></td>';
            $html .= '<td style="padding: 8px; width:10%;font-size:16px; text-align: right; ">' . number_format($dasi_cml_dasi, 2, '.', ',') . '</td>';
            $html .= '</tr>';
        ...
        if (!empty($asto_user_web)) {
            ...
            if (!empty($usuario)) {
                $sql = "select u.USUARIO_USER, concat(u.usuario_nombre,' ',u.usuario_apellido) as apenomb  from comercial.usuario u where u.USUARIO_USER = '$asto_usu_asto' ";
                $nombre_usuario = consulta_string_func($sql, 'apenomb', $oCon, '');
            }
        }

        $html .= '<tr>';
        $html .= '<td align="right" style="width:60%;font-size:16px; text-align: right; border-top:1px" colspan="3"><strong>TOTAL</strong></td>';
        $html .= '<td align="right" style="padding: 8px; width:8%;font-size:16px; text-align: right; border-top:1px"><strong>' . number_format($totalDeb, 2, '.', ',') . '</strong></td>';
        $html .= '<td align="right" style="padding: 8px; width:8%;font-size:16px; text-align: right; border-top:1px "><strong>' . number_format($totalCre, 2, '.', ',') . '</strong></td>';
        $html .= '</tr>';
        $html .= '</table>';
        $sql = "select minv_num_comp, minv_num_caja, minv_prec_caja from saeminv where minv_cod_empr='$idempresa' and minv_cod_sucu='$idsucursal' and 
				minv_cod_ejer='$ejer_cod' and minv_num_prdo='$prdo_cod' and minv_tran_minv='$asto_cod'";
        ...
        $html .= '<table style="width:95%; margin-top: 100px" align="center" >
        <tr>
            <td style="width:20%; font-size:16px; text-align: center;border-top : 2px solid black;">Elaborado por:<br>' . $nombre_usuario . '</td>
            <td style="width:4%;"></td>
            <td style="width:20%;font-size:16px; text-align: center;border-top : 2px solid black;">Revisado por:</td>
            <td style="width:4%;"></td>
            <td style="width:20%;font-size:16px; text-align: center;border-top : 2px solid black;">Aprobado por:</td>
            <td style="width:4%;"></td>
            <td style="width:20%;font-size:16px; text-align: center;border-top : 2px solid black;">Recibí Conforme:<br>' . $asto_ben_asto . '</td>
        </tr>
            </table>';
    }
    //return $oReturn;
