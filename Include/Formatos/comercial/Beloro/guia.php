            ...
            if ($oIfx2->Query($sqlTran)) {
                if ($oIfx2->NumFilas() > 0) {
                    do {
                        ...
                        $transportista .= ' <td style="width: 70%" colspan="3">' . utf8_decode($trta_nom_trta) . '</td>';
                        $transportista .= ' </tr>';
                        ...
                        $transportista .= ' <td style="width: 70% " colspan="3">' . utf8_decode($sucu_dir) . '</td>';
                        $transportista .= ' </tr>';
...
$destinatario .= ' <table style="width: 100%; border:1px solid black; border-radius: 5px; padding: 2px; font-size: 15x;">';
                    ...
                    if ($oIfx2->Query($sqlFact)) {
                        if ($oIfx2->NumFilas() > 0) {
                            do {
                                ...
                                $destinatario .= ' <td style="width: 40%" >' . $numDocSustento . '</td>';
                                $destinatario .= ' <td style="width: 30%" >Fecha de Emisión&nbsp;&nbsp;' . $fact_fech_fact . '</td>';
                                $destinatario .= ' </tr>';
                            ...
                            $destinatario .= ' <tr>';
                            $destinatario .= ' <td style="width: 30% ">Comprobante de Venta:</td>';
                            $destinatario .= ' <td style="width: 50%" ></td>';
                            $destinatario .= ' <td style="width: 20%" >Fecha de Emisión</td>';
                            $destinatario .= ' </tr>';
    ...
    $destinatario .= ' <td style="width: 70%" colspan="2" >' . utf8_decode($guia_nom_cliente) . '</td>';
    $destinatario .= ' </tr>';
    ...
    $destinatario .= ' <td style="width: 70%" colspan="2" >' . utf8_decode($ciud_des) . ' ' . $guia_dir_clie . '</td>';
    $destinatario .= ' </tr>';
    ...
    $infoadi='';
    if(!empty($guia_cm1_guia)){

        $infoadi .= ' <table style="width: 60%; font-size: 12px; border:1px solid black; margin-top:15px;">';
        $infoadi .= ' <tr>';
        $infoadi .= ' <td style="width: 100%;">Información Adicional<br>' . $guia_cm1_guia . '</td>';
        $infoadi .= ' </tr>';
        $infoadi .= ' </table>';
    }
